...
var lUnregister = function(aConnector) {
	App.debug("Processing unregister...");

	if (lClients.constainKey(aConnector.getUsername())) {
		// removing the client
...
var lGetAppClients = function() {
	App.debug("Processing get app clients...");
...
var lAcceptConnect = function(aTargetUser, aAnswer, aConnector) {
	App.debug("Processing accept connect...");
...
var lDisconnect = function(aTargetUser, aConnector) {
	App.debug("Processing disconnect...");
