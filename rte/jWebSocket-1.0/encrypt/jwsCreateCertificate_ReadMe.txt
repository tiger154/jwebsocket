...
•	Locality: Herzogenrath
•	Organisation: Innotrade GmbH
•	Common Name: <your email alias without @jwebsocket.org, e.g. dmoreno>
•	Email address: your full jwebsocket email address
•	Password: Empty (use dot ".")
