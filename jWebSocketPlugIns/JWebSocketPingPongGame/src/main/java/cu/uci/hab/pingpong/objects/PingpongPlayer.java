...
import org.jwebsocket.gaming.Player;
...
// Propiedades
    ...
    public PingpongPlayer(String aPlayerName, String aPlayerJoystick, int aPlayerScore, PingpongStage aPingpongStage) {
    ...
    private void initPlayer(PingpongStage aPingpongStage) {
        ...
        if (mPlayerJoystick.equals("playLeft")) {
            ...
            lPosX = aPingpongStage.getStageBorder() + aPingpongStage.getStageWidth() - lWidth - 8;
            lPosY = Math.round(aPingpongStage.mStageCenterY - lHeigth / 2);
    ...
    public void move(int aEvent, String aValue) {
        ...
        if (getPosition().getY() + lPixel > mPingpongStege.getStageBorderBottom() - getDimension().getHeight()) {
            getPosition().setY(mPingpongStege.getStageBorderBottom() - getDimension().getHeight());
        } else if (getPosition().getY() + lPixel < mPingpongStege.getStageBorderTop()) {
