...
public interface IQuota{
   ...
   */
   ...
   /**
    * 
    *tries to reduce the current quota by the given amount, if the quota still contains (i.e. allows) the request amount the
    *result is the new quota value, otherwise the result is less than zero, indicating that the quota is exceeded by the
    *returned amount.
    * 
    * @param aInstance
    * @param aNameSpace
   ...
   /**
    * adds the given amount to the given quota, the result is the new quota value.
    * 
    * @param aInstance
    * @param aNameSpace
    * @param aUuid
   ...
   /**
    * sets the given quota to the given value. The result is the old/previous quota value.
    * 
    * @param aInstance
    * @param aNameSpace
    * @param aUuid
   ...
   /**
    * registers an instance at the quota class, this is required to e.g. 
    * log volume in filter quotas or limit timed access.
    * 
    * @param aInstance
    * @param aNameSpace
    * @param aUuid
    ...
    *  specified  
    * 
    *  aInstanceType atr could take the following values that make reference
    *  to an InstanceType:
    * 
    * U > user       :          this is the default value taken for the 
    *                           above register method
    * G > group
    * A > app
    * M > modulate
    * 
