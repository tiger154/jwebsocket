...
//	---------------------------------------------------------------------------
if(window.jj){window.WebSocket=window.jj;}var jws={VERSION:"1.0b6 (nightly build 20404)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,gA:1000,kT:1001,iM:{dV:false,gu: -1,iH: -1,ho: -1,hn: -1},kh:{dV:true,gu:2000,iH:30000,ho:1000,hn:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",jJ:"org.jwebsocket.text",kM:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,ic:0,hB:1,hH:2,hz:3,gv:4,gl:5,jv:6,fg:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],lx:"guest",ky:"guest",lz:"root",lj:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),iE:function(){return this.ef;},hI:function(){return this.eg;},jr:function(){return this.fL;},isFirefox:function(){return this.fO;},js:function(){return this.gP;},ka:function(){return this.gH;},hu:function(){return this.gG;},hY:function(){return(this.hu()&&this.hI()<7);},iq:function(){return(this.hu()&&this.hI()<8);},kj:function(){return(this.hu()&&this.hI()>=8);},hO:function(){return this.hi;},ij:function(){return this.gJ;},iD:function(){return this.gc;},console:{eK:false,fu:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,hy:function(){return(window.console&&jws.console.eK&&jws.console.fu<=jws.console.DEBUG);},iU:function(){return(window.console&&jws.console.eK&&jws.console.fu<=jws.console.INFO);},log:function(dX){if(window.console&&jws.console.eK){console.log(dX);}},eJ:function(dX){if(window.console&&jws.console.eK&&jws.console.fu<=jws.console.DEBUG){if(console.eJ){console.eJ(dX);}else{console.log("[eJ]: "+dX);}}},info:function(dX){if(window.console&&jws.console.eK&&jws.console.fu<=jws.console.INFO){if(console.info){console.info(dX);}else{console.log("[info]: "+dX);}}},gp:function(dX){if(window.console&&jws.console.eK&&jws.console.fu<=jws.console.WARN){if(console.gp){console.gp(dX);}else{console.log("[gp]: "+dX);}}},error:function(dX){if(window.console&&jws.console.eK&&jws.console.fu<=jws.console.ERROR){if(console.error){console.error(dX);}else{console.log("[error]: "+dX);}}},gX:function(dX){if(window.console&&jws.console.eK&&jws.console.fu<=jws.console.FATAL){if(console.gX){console.gX(dX);}else{console.log("[gX]: "+dX);}}},jG:function(){return jws.console.fu;},kX:function(fo){jws.console.fu=fo;},isActive:function(){return jws.console.eK;},setActive:function(eq){jws.console.eK=eq;}}};(function(){jws.ef="unknown";jws.eo=jws.ic;jws.eg=undefined;jws.gG=false;jws.fO=false;jws.gJ=false;jws.gP=false;jws.hi=false;jws.gH=false;var dS=navigator.userAgent;jws.gH=dS.indexOf("Chrome")>=0;if(jws.gH){jws.eo=jws.jv;}else{jws.hi=dS.indexOf("Safari")>=0;if(jws.hi){jws.eo=jws.gl;}else{jws.gJ=dS.indexOf("Netscape")>=0;if(jws.gJ){jws.eo=jws.hH;}else{jws.fO=navigator.appName=="Netscape";if(jws.fO){jws.eo=jws.hB;}else{jws.gP=navigator.appName=="Opera";if(jws.gP){jws.eo=jws.hz;}else{jws.gG=navigator.appName=="Microsoft Internet Explorer";if(jws.gG){jws.eo=jws.gv;}else{jws.gc=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gc){jws.eo=jws.gv;}}}}}}}var p,i;var aK;var fj;var aJ;if(jws.gG){jws.ef=jws.fg[jws.gv];aJ=dS.match(/MSIE.*/i);if(aJ){aK=aJ[0].substr(5);p=aK.indexOf(";");jws.fL=p>0?aK.substr(0,p):aK;jws.eg=parseFloat(jws.fL);}}else if(jws.fO){jws.ef=jws.fg[jws.hB];aJ=dS.match(/Firefox\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.fL=aK.substring(0,p);}else{jws.fL=aK;}fj=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fj++;}if(fj>=2){break;}i++;}aK=aK.substring(0,i);jws.eg=parseFloat(aK);}}else if(jws.gJ){jws.ef=jws.fg[jws.hH];aJ=dS.match(/Netscape\/.*/i);if(aJ){aK=aJ[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.fL=aK.substring(0,p);}else{jws.fL=aK;}fj=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fj++;}if(fj>=2){break;}i++;}aK=aK.substring(0,i);jws.eg=parseFloat(aK);}}else if(jws.gP){jws.ef=jws.fg[jws.hz];aJ=dS.match(/Opera\/.*/i);if(aJ){aK=aJ[0].substr(6);p=aK.indexOf(" ");jws.fL=p>0?aK.substr(0,p):aK;jws.eg=parseFloat(aK);aJ=dS.match(/Version\/.*/i);aK=aJ[0].substr(8);if(aJ){p=aK.indexOf(" ");jws.fL=(p>0?aK.substr(0,p):aK)+"/"+jws.fL;jws.eg=parseFloat(aK);}}}else if(jws.gH){jws.ef=jws.fg[jws.jv];aJ=dS.match(/Chrome\/.*/i);if(aJ){aK=aJ[0].substr(7);p=aK.indexOf(" ");jws.fL=p>0?aK.substr(0,p):aK;jws.eg=parseFloat(aK);}}else if(jws.hi){jws.ef=jws.fg[jws.gl];aJ=dS.match(/Version\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");jws.fL=p>0?aK.substr(0,p):aK;fj=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fj++;}if(fj>=2){break;}i++;}aK=aK.substring(0,i);jws.eg=parseFloat(aK);aJ=dS.match(/Safari\/.*/i);if(aJ){aK="."+aJ[0].substr(7);p=aK.indexOf(" ");jws.fL+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},jl:function(fV){if(fV&&typeof ck=="string"){}return fV;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},lB:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},kK:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},kV:function(ey,gY,jD){var hN=jD||"";var hE=null;var fB=null;for(fB in gY){hE="set"+fB.substr(0,1).toUpperCase()+fB.substr(1);if(typeof(ey[hE])=="function"){ey[hE](gY[fB]);}else{ey[hN+fB]=gY[fB];}}return ey;},gD:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gD"])){return ey.gD();}if(ey instanceof Date){return new Date(ey.getTime());}var jy=function(hC){var gn=hC.length;var fS=[];if(gn>0){for(var cf=0;cf<gn;cf++){fS[cf]=jws.tools.gD(hC[cf]);}}return fS;};var dH=new ey.constructor();for(var gF in ey){var dM=ey[gF];if(dM instanceof Array)dH[gF]=jy(dM);else{dH[gF]=jws.tools.gD(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
