...
//	---------------------------------------------------------------------------
if(window.hK){window.WebSocket=window.hK;}var jws={VERSION:"1.0b6 (nightly build 20314)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,hE:1000,jM:1001,iY:{eu:false,hI: -1,ju: -1,gQ: -1,fW: -1},kV:{eu:true,hI:2000,ju:30000,gQ:1000,fW:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kg:"org.jwebsocket.text",lm:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,iE:0,hm:1,gN:2,gc:3,gp:4,gd:5,iL:6,eJ:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],kr:"guest",ly:"guest",kd:"root",lh:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),jc:function(){return this.eg;},gf:function(){return this.en;},jw:function(){return this.eK;},isFirefox:function(){return this.hu;},jF:function(){return this.hA;},kQ:function(){return this.gw;},gz:function(){return this.fX;},ik:function(){return(this.gz()&&this.gf()<7);},jB:function(){return(this.gz()&&this.gf()<8);},kB:function(){return(this.gz()&&this.gf()>=8);},jd:function(){return this.gX;},ic:function(){return this.gM;},iV:function(){return this.gP;},console:{dT:false,fB:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,hl:function(){return(window.console&&jws.console.dT&&jws.console.fB<=jws.console.DEBUG);},ir:function(){return(window.console&&jws.console.dT&&jws.console.fB<=jws.console.INFO);},log:function(fh){if(window.console&&jws.console.dT){console.log(fh);}},fu:function(fh){if(window.console&&jws.console.dT&&jws.console.fB<=jws.console.DEBUG){if(console.fu){console.fu(fh);}else{console.log("[fu]: "+fh);}}},info:function(fh){if(window.console&&jws.console.dT&&jws.console.fB<=jws.console.INFO){if(console.info){console.info(fh);}else{console.log("[info]: "+fh);}}},hG:function(fh){if(window.console&&jws.console.dT&&jws.console.fB<=jws.console.WARN){if(console.hG){console.hG(fh);}else{console.log("[hG]: "+fh);}}},error:function(fh){if(window.console&&jws.console.dT&&jws.console.fB<=jws.console.ERROR){if(console.error){console.error(fh);}else{console.log("[error]: "+fh);}}},fR:function(fh){if(window.console&&jws.console.dT&&jws.console.fB<=jws.console.FATAL){if(console.fR){console.fR(fh);}else{console.log("[fR]: "+fh);}}},kA:function(){return jws.console.fB;},lk:function(fo){jws.console.fB=fo;},isActive:function(){return jws.console.dT;},setActive:function(eq){jws.console.dT=eq;}}};(function(){jws.eg="unknown";jws.fs=jws.iE;jws.en=undefined;jws.fX=false;jws.hu=false;jws.gM=false;jws.hA=false;jws.gX=false;jws.gw=false;var eZ=navigator.userAgent;jws.gw=eZ.indexOf("Chrome")>=0;if(jws.gw){jws.fs=jws.iL;}else{jws.gX=eZ.indexOf("Safari")>=0;if(jws.gX){jws.fs=jws.gd;}else{jws.gM=eZ.indexOf("Netscape")>=0;if(jws.gM){jws.fs=jws.gN;}else{jws.hu=navigator.appName=="Netscape";if(jws.hu){jws.fs=jws.hm;}else{jws.hA=navigator.appName=="Opera";if(jws.hA){jws.fs=jws.gc;}else{jws.fX=navigator.appName=="Microsoft Internet Explorer";if(jws.fX){jws.fs=jws.gp;}else{jws.gP=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gP){jws.fs=jws.gp;}}}}}}}var p,i;var aK;var eS;var aJ;if(jws.fX){jws.eg=jws.eJ[jws.gp];aJ=eZ.match(/MSIE.*/i);if(aJ){aK=aJ[0].substr(5);p=aK.indexOf(";");jws.eK=p>0?aK.substr(0,p):aK;jws.en=parseFloat(jws.eK);}}else if(jws.hu){jws.eg=jws.eJ[jws.hm];aJ=eZ.match(/Firefox\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.eK=aK.substring(0,p);}else{jws.eK=aK;}eS=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){eS++;}if(eS>=2){break;}i++;}aK=aK.substring(0,i);jws.en=parseFloat(aK);}}else if(jws.gM){jws.eg=jws.eJ[jws.gN];aJ=eZ.match(/Netscape\/.*/i);if(aJ){aK=aJ[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.eK=aK.substring(0,p);}else{jws.eK=aK;}eS=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){eS++;}if(eS>=2){break;}i++;}aK=aK.substring(0,i);jws.en=parseFloat(aK);}}else if(jws.hA){jws.eg=jws.eJ[jws.gc];aJ=eZ.match(/Opera\/.*/i);if(aJ){aK=aJ[0].substr(6);p=aK.indexOf(" ");jws.eK=p>0?aK.substr(0,p):aK;jws.en=parseFloat(aK);aJ=eZ.match(/Version\/.*/i);aK=aJ[0].substr(8);if(aJ){p=aK.indexOf(" ");jws.eK=(p>0?aK.substr(0,p):aK)+"/"+jws.eK;jws.en=parseFloat(aK);}}}else if(jws.gw){jws.eg=jws.eJ[jws.iL];aJ=eZ.match(/Chrome\/.*/i);if(aJ){aK=aJ[0].substr(7);p=aK.indexOf(" ");jws.eK=p>0?aK.substr(0,p):aK;jws.en=parseFloat(aK);}}else if(jws.gX){jws.eg=jws.eJ[jws.gd];aJ=eZ.match(/Version\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");jws.eK=p>0?aK.substr(0,p):aK;eS=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){eS++;}if(eS>=2){break;}i++;}aK=aK.substring(0,i);jws.en=parseFloat(aK);aJ=eZ.match(/Safari\/.*/i);if(aJ){aK="."+aJ[0].substr(7);p=aK.indexOf(" ");jws.eK+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},hZ:function(ho){if(ho&&typeof ck=="string"){}return ho;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},kE:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},kM:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},ky:function(ey,hv,ix){var jn=ix||"";var gC=null;var fD=null;for(fD in hv){gC="set"+fD.substr(0,1).toUpperCase()+fD.substr(1);if(typeof(ey[gC])=="function"){ey[gC](hv[fD]);}else{ey[jn+fD]=hv[fD];}}return ey;},gV:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gV"])){return ey.gV();}if(ey instanceof Date){return new Date(ey.getTime());}var iq=function(gW){var hF=gW.length;var fS=[];if(hF>0){for(var dO=0;dO<hF;dO++){fS[dO]=jws.tools.gV(gW[dO]);}}return fS;};var dH=new ey.constructor();for(var hJ in ey){var dM=ey[hJ];if(dM instanceof Array)dH[hJ]=iq(dM);else{dH[hJ]=jws.tools.gV(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
