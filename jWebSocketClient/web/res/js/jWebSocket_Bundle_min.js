...
//	---------------------------------------------------------------------------
if(window.iF){window.WebSocket=window.iF;}var jws={VERSION:"1.0b6 (nightly build 20407)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,hd:1000,jN:1001,iA:{fq:false,gm: -1,iB: -1,hn: -1,gh: -1},lm:{fq:true,gm:2000,iB:30000,hn:1000,gh:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",lp:"org.jwebsocket.text",kX:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,hS:0,gS:1,hu:2,gM:3,gN:4,gC:5,iq:6,eW:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],kv:"guest",kS:"guest",lc:"root",lj:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),je:function(){return this.eg;},hz:function(){return this.eJ;},iP:function(){return this.fA;},isFirefox:function(){return this.gE;},iT:function(){return this.hb;},lA:function(){return this.ht;},gL:function(){return this.hj;},jE:function(){return(this.gL()&&this.hz()<7);},jC:function(){return(this.gL()&&this.hz()<8);},le:function(){return(this.gL()&&this.hz()>=8);},iY:function(){return this.gq;},ix:function(){return this.hm;},iK:function(){return this.gZ;},console:{eE:false,fk:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,fX:function(){return(window.console&&jws.console.eE&&jws.console.fk<=jws.console.DEBUG);},iS:function(){return(window.console&&jws.console.eE&&jws.console.fk<=jws.console.INFO);},log:function(dS){if(window.console&&jws.console.eE){console.log(dS);}},fi:function(dS){if(window.console&&jws.console.eE&&jws.console.fk<=jws.console.DEBUG){if(console.fi){console.fi(dS);}else{console.log("[fi]: "+dS);}}},info:function(dS){if(window.console&&jws.console.eE&&jws.console.fk<=jws.console.INFO){if(console.info){console.info(dS);}else{console.log("[info]: "+dS);}}},gJ:function(dS){if(window.console&&jws.console.eE&&jws.console.fk<=jws.console.WARN){if(console.gJ){console.gJ(dS);}else{console.log("[gJ]: "+dS);}}},error:function(dS){if(window.console&&jws.console.eE&&jws.console.fk<=jws.console.ERROR){if(console.error){console.error(dS);}else{console.log("[error]: "+dS);}}},gy:function(dS){if(window.console&&jws.console.eE&&jws.console.fk<=jws.console.FATAL){if(console.gy){console.gy(dS);}else{console.log("[gy]: "+dS);}}},kR:function(){return jws.console.fk;},jJ:function(fo){jws.console.fk=fo;},isActive:function(){return jws.console.eE;},setActive:function(eq){jws.console.eE=eq;}}};(function(){jws.eg="unknown";jws.en=jws.hS;jws.eJ=undefined;jws.hj=false;jws.gE=false;jws.hm=false;jws.hb=false;jws.gq=false;jws.ht=false;var ft=navigator.userAgent;jws.ht=ft.indexOf("Chrome")>=0;if(jws.ht){jws.en=jws.iq;}else{jws.gq=ft.indexOf("Safari")>=0;if(jws.gq){jws.en=jws.gC;}else{jws.hm=ft.indexOf("Netscape")>=0;if(jws.hm){jws.en=jws.hu;}else{jws.gE=navigator.appName=="Netscape";if(jws.gE){jws.en=jws.gS;}else{jws.hb=navigator.appName=="Opera";if(jws.hb){jws.en=jws.gM;}else{jws.hj=navigator.appName=="Microsoft Internet Explorer";if(jws.hj){jws.en=jws.gN;}else{jws.gZ=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gZ){jws.en=jws.gN;}}}}}}}var p,i;var aK;var fD;var aJ;if(jws.hj){jws.eg=jws.eW[jws.gN];aJ=ft.match(/MSIE.*/i);if(aJ){aK=aJ[0].substr(5);p=aK.indexOf(";");jws.fA=p>0?aK.substr(0,p):aK;jws.eJ=parseFloat(jws.fA);}}else if(jws.gE){jws.eg=jws.eW[jws.gS];aJ=ft.match(/Firefox\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.fA=aK.substring(0,p);}else{jws.fA=aK;}fD=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fD++;}if(fD>=2){break;}i++;}aK=aK.substring(0,i);jws.eJ=parseFloat(aK);}}else if(jws.hm){jws.eg=jws.eW[jws.hu];aJ=ft.match(/Netscape\/.*/i);if(aJ){aK=aJ[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.fA=aK.substring(0,p);}else{jws.fA=aK;}fD=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fD++;}if(fD>=2){break;}i++;}aK=aK.substring(0,i);jws.eJ=parseFloat(aK);}}else if(jws.hb){jws.eg=jws.eW[jws.gM];aJ=ft.match(/Opera\/.*/i);if(aJ){aK=aJ[0].substr(6);p=aK.indexOf(" ");jws.fA=p>0?aK.substr(0,p):aK;jws.eJ=parseFloat(aK);aJ=ft.match(/Version\/.*/i);aK=aJ[0].substr(8);if(aJ){p=aK.indexOf(" ");jws.fA=(p>0?aK.substr(0,p):aK)+"/"+jws.fA;jws.eJ=parseFloat(aK);}}}else if(jws.ht){jws.eg=jws.eW[jws.iq];aJ=ft.match(/Chrome\/.*/i);if(aJ){aK=aJ[0].substr(7);p=aK.indexOf(" ");jws.fA=p>0?aK.substr(0,p):aK;jws.eJ=parseFloat(aK);}}else if(jws.gq){jws.eg=jws.eW[jws.gC];aJ=ft.match(/Version\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");jws.fA=p>0?aK.substr(0,p):aK;fD=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fD++;}if(fD>=2){break;}i++;}aK=aK.substring(0,i);jws.eJ=parseFloat(aK);aJ=ft.match(/Safari\/.*/i);if(aJ){aK="."+aJ[0].substr(7);p=aK.indexOf(" ");jws.fA+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},ig:function(fU){if(fU&&typeof ck=="string"){}return fU;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},lu:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},ky:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},kF:function(ey,ho,jo){var iz=jo||"";var gb=null;var fL=null;for(fL in ho){gb="set"+fL.substr(0,1).toUpperCase()+fL.substr(1);if(typeof(ey[gb])=="function"){ey[gb](ho[fL]);}else{ey[iz+fL]=ho[fL];}}return ey;},gw:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gw"])){return ey.gw();}if(ey instanceof Date){return new Date(ey.getTime());}var iC=function(gs){var hA=gs.length;var gK=[];if(hA>0){for(var cf=0;cf<hA;cf++){gK[cf]=jws.tools.gw(gs[cf]);}}return gK;};var dH=new ey.constructor();for(var fP in ey){var dM=ey[fP];if(dM instanceof Array)dH[fP]=iC(dM);else{dH[fP]=jws.tools.gw(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
