...
//	---------------------------------------------------------------------------
if(window.hM){window.WebSocket=window.hM;}var jws={VERSION:"1.0b6 (nightly build 20412)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,hF:1000,kl:1001,jg:{fD:false,hs: -1,iu: -1,gk: -1,gE: -1},jS:{fD:true,hs:2000,iu:30000,gk:1000,gE:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",ld:"org.jwebsocket.text",lw:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,jr:0,gm:1,gy:2,gG:3,hm:4,hi:5,ju:6,eu:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],la:"guest",jU:"guest",ki:"root",ly:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),hQ:function(){return this.fL;},hD:function(){return this.fE;},jo:function(){return this.fI;},isFirefox:function(){return this.fO;},iq:function(){return this.hd;},kO:function(){return this.he;},gT:function(){return this.hb;},jb:function(){return(this.gT()&&this.hD()<7);},jB:function(){return(this.gT()&&this.hD()<8);},ln:function(){return(this.gT()&&this.hD()>=8);},ja:function(){return this.gF;},iX:function(){return this.gH;},iW:function(){return this.gf;},console:{fs:false,fj:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,hE:function(){return(window.console&&jws.console.fs&&jws.console.fj<=jws.console.DEBUG);},jc:function(){return(window.console&&jws.console.fs&&jws.console.fj<=jws.console.INFO);},log:function(ft){if(window.console&&jws.console.fs){console.log(ft);}},ef:function(ft){if(window.console&&jws.console.fs&&jws.console.fj<=jws.console.DEBUG){if(console.ef){console.ef(ft);}else{console.log("[ef]: "+ft);}}},info:function(ft){if(window.console&&jws.console.fs&&jws.console.fj<=jws.console.INFO){if(console.info){console.info(ft);}else{console.log("[info]: "+ft);}}},gs:function(ft){if(window.console&&jws.console.fs&&jws.console.fj<=jws.console.WARN){if(console.gs){console.gs(ft);}else{console.log("[gs]: "+ft);}}},error:function(ft){if(window.console&&jws.console.fs&&jws.console.fj<=jws.console.ERROR){if(console.error){console.error(ft);}else{console.log("[error]: "+ft);}}},fP:function(ft){if(window.console&&jws.console.fs&&jws.console.fj<=jws.console.FATAL){if(console.fP){console.fP(ft);}else{console.log("[fP]: "+ft);}}},kQ:function(){return jws.console.fj;},jJ:function(fo){jws.console.fj=fo;},isActive:function(){return jws.console.fs;},setActive:function(eq){jws.console.fs=eq;}}};(function(){jws.fL="unknown";jws.fF=jws.jr;jws.fE=undefined;jws.hb=false;jws.fO=false;jws.gH=false;jws.hd=false;jws.gF=false;jws.he=false;var eh=navigator.userAgent;jws.he=eh.indexOf("Chrome")>=0;if(jws.he){jws.fF=jws.ju;}else{jws.gF=eh.indexOf("Safari")>=0;if(jws.gF){jws.fF=jws.hi;}else{jws.gH=eh.indexOf("Netscape")>=0;if(jws.gH){jws.fF=jws.gy;}else{jws.fO=navigator.appName=="Netscape";if(jws.fO){jws.fF=jws.gm;}else{jws.hd=navigator.appName=="Opera";if(jws.hd){jws.fF=jws.gG;}else{jws.hb=navigator.appName=="Microsoft Internet Explorer";if(jws.hb){jws.fF=jws.hm;}else{jws.gf=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gf){jws.fF=jws.hm;}}}}}}}var p,i;var aJ;var eJ;var aK;if(jws.hb){jws.fL=jws.eu[jws.hm];aK=eh.match(/MSIE.*/i);if(aK){aJ=aK[0].substr(5);p=aJ.indexOf(";");jws.fI=p>0?aJ.substr(0,p):aJ;jws.fE=parseFloat(jws.fI);}}else if(jws.fO){jws.fL=jws.eu[jws.gm];aK=eh.match(/Firefox\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");if(p>0){jws.fI=aJ.substring(0,p);}else{jws.fI=aJ;}eJ=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eJ++;}if(eJ>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fE=parseFloat(aJ);}}else if(jws.gH){jws.fL=jws.eu[jws.gy];aK=eh.match(/Netscape\/.*/i);if(aK){aJ=aK[0].substr(9);p=aJ.indexOf(" ");if(p>0){jws.fI=aJ.substring(0,p);}else{jws.fI=aJ;}eJ=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eJ++;}if(eJ>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fE=parseFloat(aJ);}}else if(jws.hd){jws.fL=jws.eu[jws.gG];aK=eh.match(/Opera\/.*/i);if(aK){aJ=aK[0].substr(6);p=aJ.indexOf(" ");jws.fI=p>0?aJ.substr(0,p):aJ;jws.fE=parseFloat(aJ);aK=eh.match(/Version\/.*/i);aJ=aK[0].substr(8);if(aK){p=aJ.indexOf(" ");jws.fI=(p>0?aJ.substr(0,p):aJ)+"/"+jws.fI;jws.fE=parseFloat(aJ);}}}else if(jws.he){jws.fL=jws.eu[jws.ju];aK=eh.match(/Chrome\/.*/i);if(aK){aJ=aK[0].substr(7);p=aJ.indexOf(" ");jws.fI=p>0?aJ.substr(0,p):aJ;jws.fE=parseFloat(aJ);}}else if(jws.gF){jws.fL=jws.eu[jws.hi];aK=eh.match(/Version\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");jws.fI=p>0?aJ.substr(0,p):aJ;eJ=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eJ++;}if(eJ>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fE=parseFloat(aJ);aK=eh.match(/Safari\/.*/i);if(aK){aJ="."+aK[0].substr(7);p=aJ.indexOf(" ");jws.fI+=p>0?aJ.substr(0,p):aJ;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},hY:function(gS){if(gS&&typeof ck=="string"){}return gS;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},kZ:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},jQ:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},kF:function(ey,hk,ih){var iE=ih||"";var hj=null;var eW=null;for(eW in hk){hj="set"+eW.substr(0,1).toUpperCase()+eW.substr(1);if(typeof(ey[hj])=="function"){ey[hj](hk[eW]);}else{ey[iE+eW]=hk[eW];}}return ey;},gj:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gj"])){return ey.gj();}if(ey instanceof Date){return new Date(ey.getTime());}var iI=function(gY){var gd=gY.length;var ge=[];if(gd>0){for(var dO=0;dO<gd;dO++){ge[dO]=jws.tools.gj(gY[dO]);}}return ge;};var dH=new ey.constructor();for(var hq in ey){var dM=ey[hq];if(dM instanceof Array)dH[hq]=iI(dM);else{dH[hq]=jws.tools.gj(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
