...
//	---------------------------------------------------------------------------
if(window.hU){window.WebSocket=window.hU;}var jws={VERSION:"1.0b6 (nightly build 20314)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,fY:1000,kg:1001,je:{fE:false,fU: -1,ic: -1,gm: -1,gP: -1},jL:{fE:true,fU:2000,ic:30000,gm:1000,gP:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",jN:"org.jwebsocket.text",kG:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,iZ:0,hE:1,fT:2,hC:3,gN:4,gH:5,jt:6,er:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],kW:"guest",jR:"guest",kX:"root",lq:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),jb:function(){return this.fq;},gc:function(){return this.ee;},jA:function(){return this.fF;},isFirefox:function(){return this.gF;},iO:function(){return this.gp;},lf:function(){return this.ge;},gu:function(){return this.gE;},jn:function(){return(this.gu()&&this.gc()<7);},iF:function(){return(this.gu()&&this.gc()<8);},kx:function(){return(this.gu()&&this.gc()>=8);},hS:function(){return this.fO;},hR:function(){return this.gC;},hV:function(){return this.he;},console:{eh:false,eH:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,hn:function(){return(window.console&&jws.console.eh&&jws.console.eH<=jws.console.DEBUG);},iP:function(){return(window.console&&jws.console.eh&&jws.console.eH<=jws.console.INFO);},log:function(fC){if(window.console&&jws.console.eh){console.log(fC);}},eW:function(fC){if(window.console&&jws.console.eh&&jws.console.eH<=jws.console.DEBUG){if(console.eW){console.eW(fC);}else{console.log("[eW]: "+fC);}}},info:function(fC){if(window.console&&jws.console.eh&&jws.console.eH<=jws.console.INFO){if(console.info){console.info(fC);}else{console.log("[info]: "+fC);}}},gX:function(fC){if(window.console&&jws.console.eh&&jws.console.eH<=jws.console.WARN){if(console.gX){console.gX(fC);}else{console.log("[gX]: "+fC);}}},error:function(fC){if(window.console&&jws.console.eh&&jws.console.eH<=jws.console.ERROR){if(console.error){console.error(fC);}else{console.log("[error]: "+fC);}}},gR:function(fC){if(window.console&&jws.console.eh&&jws.console.eH<=jws.console.FATAL){if(console.gR){console.gR(fC);}else{console.log("[gR]: "+fC);}}},lo:function(){return jws.console.eH;},ka:function(fo){jws.console.eH=fo;},isActive:function(){return jws.console.eh;},setActive:function(eq){jws.console.eh=eq;}}};(function(){jws.fq="unknown";jws.eD=jws.iZ;jws.ee=undefined;jws.gE=false;jws.gF=false;jws.gC=false;jws.gp=false;jws.fO=false;jws.ge=false;var fu=navigator.userAgent;jws.ge=fu.indexOf("Chrome")>=0;if(jws.ge){jws.eD=jws.jt;}else{jws.fO=fu.indexOf("Safari")>=0;if(jws.fO){jws.eD=jws.gH;}else{jws.gC=fu.indexOf("Netscape")>=0;if(jws.gC){jws.eD=jws.fT;}else{jws.gF=navigator.appName=="Netscape";if(jws.gF){jws.eD=jws.hE;}else{jws.gp=navigator.appName=="Opera";if(jws.gp){jws.eD=jws.hC;}else{jws.gE=navigator.appName=="Microsoft Internet Explorer";if(jws.gE){jws.eD=jws.gN;}else{jws.he=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.he){jws.eD=jws.gN;}}}}}}}var p,i;var aK;var fG;var aJ;if(jws.gE){jws.fq=jws.er[jws.gN];aJ=fu.match(/MSIE.*/i);if(aJ){aK=aJ[0].substr(5);p=aK.indexOf(";");jws.fF=p>0?aK.substr(0,p):aK;jws.ee=parseFloat(jws.fF);}}else if(jws.gF){jws.fq=jws.er[jws.hE];aJ=fu.match(/Firefox\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.fF=aK.substring(0,p);}else{jws.fF=aK;}fG=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fG++;}if(fG>=2){break;}i++;}aK=aK.substring(0,i);jws.ee=parseFloat(aK);}}else if(jws.gC){jws.fq=jws.er[jws.fT];aJ=fu.match(/Netscape\/.*/i);if(aJ){aK=aJ[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.fF=aK.substring(0,p);}else{jws.fF=aK;}fG=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fG++;}if(fG>=2){break;}i++;}aK=aK.substring(0,i);jws.ee=parseFloat(aK);}}else if(jws.gp){jws.fq=jws.er[jws.hC];aJ=fu.match(/Opera\/.*/i);if(aJ){aK=aJ[0].substr(6);p=aK.indexOf(" ");jws.fF=p>0?aK.substr(0,p):aK;jws.ee=parseFloat(aK);aJ=fu.match(/Version\/.*/i);aK=aJ[0].substr(8);if(aJ){p=aK.indexOf(" ");jws.fF=(p>0?aK.substr(0,p):aK)+"/"+jws.fF;jws.ee=parseFloat(aK);}}}else if(jws.ge){jws.fq=jws.er[jws.jt];aJ=fu.match(/Chrome\/.*/i);if(aJ){aK=aJ[0].substr(7);p=aK.indexOf(" ");jws.fF=p>0?aK.substr(0,p):aK;jws.ee=parseFloat(aK);}}else if(jws.fO){jws.fq=jws.er[jws.gH];aJ=fu.match(/Version\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");jws.fF=p>0?aK.substr(0,p):aK;fG=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fG++;}if(fG>=2){break;}i++;}aK=aK.substring(0,i);jws.ee=parseFloat(aK);aJ=fu.match(/Safari\/.*/i);if(aJ){aK="."+aJ[0].substr(7);p=aK.indexOf(" ");jws.fF+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},iQ:function(gL){if(gL&&typeof ck=="string"){}return gL;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},jH:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},kr:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},jI:function(ey,gI,iD){var hN=iD||"";var gq=null;var fA=null;for(fA in gI){gq="set"+fA.substr(0,1).toUpperCase()+fA.substr(1);if(typeof(ey[gq])=="function"){ey[gq](gI[fA]);}else{ey[hN+fA]=gI[fA];}}return ey;},hi:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["hi"])){return ey.hi();}if(ey instanceof Date){return new Date(ey.getTime());}var iJ=function(hI){var gJ=hI.length;var gA=[];if(gJ>0){for(var cf=0;cf<gJ;cf++){gA[cf]=jws.tools.hi(hI[cf]);}}return gA;};var dH=new ey.constructor();for(var gO in ey){var dM=ey[gO];if(dM instanceof Array)dH[gO]=iJ(dM);else{dH[gO]=jws.tools.hi(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
