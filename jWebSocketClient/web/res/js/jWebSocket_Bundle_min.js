...
JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,
JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(
self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,
RECONNECTING:1000,OPEN_TIMED_OUT:1001,RO_OFF:{autoReconnect:false,reconnectDelay: -1,reconnectTimeout: -1,queueItemLimit: -1,
queueSizeLimit: -1},RO_ON:{autoReconnect:true,reconnectDelay:2000,reconnectTimeout:30000,queueItemLimit:1000,queueSizeLimit:1024*
1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",
WS_SUBPROT_CUSTOM:"org.jwebsocket.text",WS_SUBPROT_TEXT:"org.jwebsocket.text",WS_SUBPROT_BINARY:"org.jwebsocket.binary",
SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,BT_UNKNOWN:0,BT_FIREFOX:1,BT_NETSCAPE:2,BT_OPERA:3,
BT_IEXPLORER:4,BT_SAFARI:5,BT_CHROME:6,BROWSER_NAMES:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],
GUEST_USER_LOGINNAME:"guest",GUEST_USER_PASSWORD:"guest",DEMO_ROOT_LOGINNAME:"root",DEMO_ROOT_PASSWORD:"root",$:function(aT){
return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var el=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){
el+=dL;if(dc&&dc.length>0){el+=dc;}}return el;},getWebAppURL:function(dL,dc){var is=dL||self.location.pathname;var jF=dc||
jws.JWS_SERVER_SERVLET;return jws.getServerURL("https"===self.location.protocol?"wss":"ws",self.location.hostname,
self.location.port,is,jF);},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,
jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultServerCometURL:function(){
return this.getDefaultServerURL()+"Comet";},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,
jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerCometURL:function()
{return this.getDefaultSSLServerURL()+"Comet";},getAutoServerURL:function(){var iL=location.protocol&&location.protocol.indexOf(
"https")>=0;return(this.getServerURL((iL?jws.JWS_SERVER_SSL_SCHEMA:jws.JWS_SERVER_SCHEMA),jws.JWS_SERVER_HOST,(iL?
jws.JWS_SERVER_SSL_PORT:jws.JWS_SERVER_PORT),jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){
return(window.WebSocket!==null&&window.WebSocket!==undefined);},enableCometSupportForWebSockets:function(){window.WebSocket=
XHRWebSocket;},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),
browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(
window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&
window.Worker!==undefined);})(),getOptions:function(ax,gx){ax=(ax?ax:{});if(gx){for(var dR in gx){if(undefined===ax[dR]){ax[dR]=
gx[dR];}}}return ax;},loadScript:function(dr,ax){if(!ax){ax={};}var gp=document.getElementsByTagName("head")[0];bi=
document.createElement("script");bi.type="text/javascript";if(ax.id){bi.id=ax.id;}gp.appendChild(bi);if(ax.OnSuccess){bi.onload=
ax.OnSuccess;}if(ax.OnFailure){bi.onerror=ax.OnFailure;}bi.src=dr;},runAsThread:function(ax){if(!this.browserSupportsWebWorkers){
return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+
"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&"function"===typeof ax.OnMessage){dv=ax.OnMessage;}if(ax.OnError&&
"function"===typeof ax.OnError){dG=ax.OnError;}if(ax.file&&"String"===typeof ax.file){dw=ax.file;}if(ax.method&&"function"===
typeof ax.method){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=
function(cz){if(null!==dv){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(null!==dG){dG.call(dJ,{message:
cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(
function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){
ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(
function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),getBrowserName:function(){return this.eJ;},
getBrowserVersion:function(){return this.fd;},getBrowserVersionString:function(){return this.dO;},isFirefox:function(){
return this.fh;},isOpera:function(){return this.eg;},isChrome:function(){return this.fL;},isIExplorer:function(){return this.dZ;},
isIE_LE6:function(){return(this.isIExplorer()&&this.getBrowserVersion()<7);},isIE_LE7:function(){return(this.isIExplorer()&&
this.getBrowserVersion()<8);},isIE_GE8:function(){return(this.isIExplorer()&&this.getBrowserVersion()>=8);},isSafari:function(){
return this.eo;},isNetscape:function(){return this.fj;},isPocketIE:function(){return this.hw;},console:{eZ:false,fy:2,iY:512,ALL:0,
DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,isDebugEnabled:function(){return(window.console&&jws.console.eZ&&jws.console.fy<=
jws.console.DEBUG);},isInfoEnabled:function(){return(window.console&&jws.console.eZ&&jws.console.fy<=jws.console.INFO);},log:
function(cW){if(window.console&&jws.console.eZ){console.log(cW);}},debug:function(cW){if(window.console&&jws.console.eZ&&
jws.console.fy<=jws.console.DEBUG){if(console.debug){console.debug(cW);}else{console.log("[debug]: "+cW);}}},info:function(cW){if(
window.console&&jws.console.eZ&&jws.console.fy<=jws.console.INFO){if(console.info){console.info(cW);}else{console.log("[info]: "+cW)
;}}},warn:function(cW){if(window.console&&jws.console.eZ&&jws.console.fy<=jws.console.WARN){if(console.warn){console.warn(cW);}else{
console.log("[warn]: "+cW);}}},error:function(cW){if(window.console&&jws.console.eZ&&jws.console.fy<=jws.console.ERROR){if(
console.error){console.error(cW);}else{console.log("[error]: "+cW);}}},fatal:function(cW){if(window.console&&jws.console.eZ&&
jws.console.fy<=jws.console.FATAL){if(console.fatal){console.fatal(cW);}else{console.log("[fatal]: "+cW);}}},getMaxLogLineLen:
function(){return jws.console.iY;},getLevel:function(){return jws.console.fy;},setLevel:function(fo){jws.console.fy=fo;},isActive:
function(){return jws.console.eZ;},setActive:function(eq){jws.console.eZ=eq;}}};(function(){jws.eJ="unknown";jws.eT=jws.BT_UNKNOWN;
jws.fd=undefined;jws.dZ=false;jws.fh=false;jws.fj=false;jws.eg=false;jws.eo=false;jws.fL=false;var fN=navigator.userAgent;jws.fL=
fN.indexOf("Chrome")>=0;if(jws.fL){jws.eT=jws.BT_CHROME;}else{jws.eo=fN.indexOf("Safari")>=0;if(jws.eo){jws.eT=jws.BT_SAFARI;}else{
jws.fj=fN.indexOf("Netscape")>=0;if(jws.fj){jws.eT=jws.BT_NETSCAPE;}else{jws.fh="Netscape"===navigator.appName;if(jws.fh){jws.eT=
jws.BT_FIREFOX;}else{jws.eg="Opera"===navigator.appName;if(jws.eg){jws.eT=jws.BT_OPERA;}else{jws.dZ="Microsoft Internet Explorer"===
navigator.appName;if(jws.dZ){jws.eT=jws.BT_IEXPLORER;}else{jws.hw="Microsoft Pocket Internet Explorer"===navigator.appName;if(
jws.hw){jws.eT=jws.BT_IEXPLORER;}}}}}}}var p,db;var aK;var fi;var cf;if(jws.dZ){jws.eJ=jws.BROWSER_NAMES[jws.BT_IEXPLORER];cf=
fN.match(/MSIE.*/i);if(cf){aK=cf[0].substr(5);p=aK.indexOf(";");jws.dO=p>0?aK.substr(0,p):aK;jws.fd=parseFloat(jws.dO);}}else if(
jws.fh){jws.eJ=jws.BROWSER_NAMES[jws.BT_FIREFOX];cf=fN.match(/Firefox\/.*/i);if(cf){aK=cf[0].substr(8);p=aK.indexOf(" ");if(p>0){
jws.dO=aK.substring(0,p);}else{jws.dO=aK;}fi=0;db=0;while(db<aK.length){if('.'===aK.charAt(db)){fi++;}if(fi>=2){break;}db++;}aK=
aK.substring(0,db);jws.fd=parseFloat(aK);}}else if(jws.fj){jws.eJ=jws.BROWSER_NAMES[jws.BT_NETSCAPE];cf=fN.match(/Netscape\/.*/i);
if(cf){aK=cf[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.dO=aK.substring(0,p);}else{jws.dO=aK;}fi=0;db=0;while(db<aK.length){if(
'.'===aK.charAt(db)){fi++;}if(fi>=2){break;}db++;}aK=aK.substring(0,db);jws.fd=parseFloat(aK);}}else if(jws.eg){jws.eJ=
jws.BROWSER_NAMES[jws.BT_OPERA];cf=fN.match(/Opera\/.*/i);if(cf){aK=cf[0].substr(6);p=aK.indexOf(" ");jws.dO=p>0?aK.substr(0,p):aK;
jws.fd=parseFloat(aK);cf=fN.match(/Version\/.*/i);aK=cf[0].substr(8);if(cf){p=aK.indexOf(" ");jws.dO=(p>0?aK.substr(0,p):aK)+"/"+
jws.dO;jws.fd=parseFloat(aK);}}}else if(jws.fL){jws.eJ=jws.BROWSER_NAMES[jws.BT_CHROME];cf=fN.match(/Chrome\/.*/i);if(cf){aK=
cf[0].substr(7);p=aK.indexOf(" ");jws.dO=p>0?aK.substr(0,p):aK;jws.fd=parseFloat(aK);}}else if(jws.eo){jws.eJ=
jws.BROWSER_NAMES[jws.BT_SAFARI];cf=fN.match(/Version\/.*/i);if(cf){aK=cf[0].substr(8);p=aK.indexOf(" ");jws.dO=p>0?aK.substr(0,p):
aK;fi=0;db=0;while(db<aK.length){if('.'===aK.charAt(db)){fi++;}if(fi>=2){break;}db++;}aK=aK.substring(0,db);jws.fd=parseFloat(aK);
cf=fN.match(/Safari\/.*/i);if(cf){aK="."+cf[0].substr(7);p=aK.indexOf(" ");jws.dO+=p>0?aK.substr(0,p):aK;}}}}());jws.events={
addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),
removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false)
;}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){
cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();}),stopEvent:(jws.isIE?function(cz){if(cz&&
cz.preventDefault){return cz.preventDefault();}}:function(cz){return cz.stopPropagation();})};
/*
...
dT.join("");return iC;}};if(!jws.browserSupportsNativeWebSockets){
	...
	if(swfobject.hasFlashPlayerVersion("10.0.0")){WEB_SOCKET_DEBUG=true;(function(){var bf=document.getElementsByTagName("script");for(
var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf(
"jWebSocket_Bundle_min.js");if(bg<0){bg=ad.lastIndexOf("jWebSocket_Bundle.js");}if(bg<0){bg=ad.lastIndexOf("jWebSocket.js");}if(bg>
0){window.WEB_SOCKET_SWF_LOCATION=ad.substr(0,bg)+"flash-bridge/WebSocketMain.swf";jws.JWS_FLASHBRIDGE=
window.WEB_SOCKET_SWF_LOCATION;break;}}}})();if(window.WEB_SOCKET_SWF_LOCATION){
...
null,{registerFilters:function(){},create:function(ax){if(!this.ac){this.ac=jws.RO_OFF;}},processOpened:function(cz){},
processPacket:function(cz){return cz;},processClosed:function(cz){},open:function(dr,ax){if(!ax){ax={};}var iV=ax['wsClass']||
self.WebSocket;if(iV){if(!this.dD||this.dD.readyState>2){var dJ=this;var dM=null;var dI=jws.WS_SUBPROT_JSON;if(ax.subProtocol){dI=
...
);}dJ.fInFragments={};dJ.en={};dJ.fB={};if(dJ.eW){clearTimeout(dJ.eW);dJ.eW=null;}dJ.fI=jws.OPEN;dJ.ho=cz;};this.dD.onmessage=
function(cz){if(("undefined"!==typeof Blob&&cz.data instanceof Blob)||("undefined"!==typeof ArrayBuffer&&
cz.data instanceof ArrayBuffer)){if(ax.OnMessage){ax.OnMessage(cz,dM,dJ);}return;}var dg=cz.data;try{var ij=JSON.parse(dg);if(
ij["jwsWrappedMsg"]){if("message"===ij.type){var aJ=ij.msgId;if(ij.isAckRequired){dJ.sendStream(JSON.stringify({"jwsWrappedMsg":
true,name:"ack",data:aJ,type:"info"}));}if(ij.isFragment){if(undefined===dJ.fInFragments[ij.fragmentationId]){
dJ.fInFragments[ij.fragmentationId]=ij.data;}else{dJ.fInFragments[ij.fragmentationId]+=ij.data;}if(ij.isLastFragment){dg=
dJ.fInFragments[ij.fragmentationId];delete dJ.fInFragments[ij.fragmentationId];}else{return;}}else{dg=ij.data;}}else if("info"===
ij.type){if("ack"===ij.name){clearTimeout(dJ.fB[ij.data]);if(dJ.en[ij.data]){dJ.en[ij.data].OnSuccess();delete dJ.en[ij.data];
delete dJ.fB[ij.data];}return;}else if("maxFrameSize"===ij.name){dJ.ee=ij.data;jws.events.stopEvent(cz);if(
...
throw new Error("WebSockets not supported by browser");}},connect:function(dr,ax){return this.open(dr,ax);},processQueue:function(){
if(this.ej){var bj=this.checkConnected();if(0===bj.code){var cE;while(this.ej.length>0){cE=this.ej.shift();this.dD.send(cE.packet);}
}}},queuePacket:function(fW,ax){if(!this.ej){this.ej=[];}this.ej.push({packet:fW,options:ax});},sendStream:function(aw){if(
aw.length>this.ee){throw new Error("Data packet discarded. The packet size "+"exceeds the max frame size supported by the client!");
}if(this.isOpened()){try{if(this.iX){for(var db=0,cF=this.iX.length;db<cF;db++){if("function"===
typeof this.iX[db]["filterStreamOut"]){this.iX[db]["filterStreamOut"](aw);}}}this.dD.send(aw);}catch(dQ){jws.console.error(
"[sendStream]: Exception on send: "+dQ.message);}}else{if(this.isWriteable()){this.queuePacket(aw,null);}else{throw new Error(
"Not connected");}}},sendStreamInTransaction:function(aw,aA,eu){var aJ=""+jws.tools.getUniqueInteger();var dJ=this;try{if(
undefined===eu){eu=this.ee;}else if(eu<0||eu>this.ee){throw new Error("Invalid 'fragment size' argument. "+
...
setQueueItemLimit:function(eb){if(eb&&"number"===typeof(eb)&&eb>0){this.ac.queueItemLimit=parseInt(eb);}else{this.ac.queueItemLimit=
0;}},setQueueSizeLimit:function(eb){if(eb&&"number"===typeof(eb)&&eb>0){this.ac.queueSizeLimit=parseInt(eb);}else{
this.ac.queueSizeLimit=0;}},setReliabilityOptions:function(ax){this.ac=ax;if(this.ac){if(this.ac.autoReconnect){}else{
this.abortReconnect();}}},getReliabilityOptions:function(){return this.ac;},getOutQueue:function(){return this.ej;},resetSendQueue:
function(){delete this.ej;},isOpened:function(){return(undefined!==this.dD&&null!==this.dD&&jws.OPEN===this.dD.readyState);},getURL:
function(){return this.hp;},getSubProt:function(){return this.gQ;},isConnected:function(){return(this.isOpened());},forceClose:
function(ax){var aZ=false;if(this.ac){this.ac.isExplicitClose=true;}if(ax){if(ax.fireClose&&this.dD.onclose){var aW={};
this.dD.onclose(aW);}}if(this.dD){this.dD.onopen=null;this.dD.onmessage=null;this.dD.onclose=null;if(this.dD.readyState===jws.OPEN||
this.dD.readyState===jws.CONNECTING){this.dD.close();}this.processClosed();}this.dD=null;},close:function(ax){var aj=0;if(ax){if(
ax.timeout){aj=ax.timeout;}}if(this.dD&&1===this.dD.readyState){if(aj<=0){this.forceClose(ax);}else{var dJ=this;this.az=setTimeout(
function(){dJ.forceClose(ax);},aj);}}else{this.dD=null;throw new Error("Not connected");}},disconnect:function(ax){
return this.close(ax);},addListener:function(cX){if(!this.cO){this.cO=[];}this.cO.push(cX);},removeListener:function(cX){if(this.cO)
{for(var db=0,dB=this.cO;db<dB;db++){if(cX===this.cO[db]){this.cO.splice(db,1);}}}},addFilter:function(jn){if(!this.iX){this.iX=[];}
this.iX.push(jn);},removeFilter:function(jn){if(this.iX){for(var db=0,dB=this.iX;db<dB;db++){if(jn===this.iX[db]){this.iX.splice(db,
1);}}}},addPlugIn:function(ap,aT){if(!this.cx){this.cx=[];}this.cx.push(ap);if(!aT){aT=ap.ID;}if(aT){ap.conn=this;}},setParam:
function(ae,ck){if(!this.dS){this.dS={};}var gf=this.getParam(ae);this.dS[ae]=ck;return gf;},getParam:function(ae){if(!this.dS){
return null;}var bj=this.dS[ae];if(bj===undefined){return null;}return bj;},setParamNS:function(fC,ae,ck){return this.setParam(fC+
"."+ae,ck);},getParamNS:function(fC,ae){return this.getParam(fC+"."+ae);},clearParams:function(){if(this.dS){delete this.dS;}}});
...
function(){this.OnChunkDelivered(this.dV);if(this.hb.hasNext()){try{this.dV=mChunkableIterator.next();if(!this.dV){throw new Error(
...
ax.OnGoodBye&&"function"===typeof ax.OnGoodBye){this.fw=ax.OnGoodBye;}if(ax&&ax.OnLogon&&"function"===typeof ax.OnLogon){this.gZ=
ax.OnLogon;}if(ax&&ax.OnLogoff&&"function"===typeof ax.OnLogoff){this.hH=ax.OnLogoff;}arguments.callee.inherited.call(this,dr,ax);}
catch(ex){bj.code= -1;bj.localeKey="jws.jsc.ex";bj.args=[ex.message];bj.msg="Exception on open: "+ex.message;}return bj;},connect:
function(dr,ax){return this.open(dr,ax);},close:function(ax){var aj=0;var cD=false;var cZ=false;var cV=false;if(this.ac){
this.ac.isExplicitClose=true;}if(ax){if(ax.timeout){aj=ax.timeout;}if(ax.noGoodBye){cD=true;}if(ax.noLogoutBroadcast){cZ=true;}if(
ax.noDisconnectBroadcast){cV=true;}}var bj=this.checkConnected();try{if(0===bj.code){if(aj>0){var cg={ns:jws.NS_SYSTEM,type:"close",
timeout:aj};if(cD){cg.noGoodBye=true;}if(cZ){cg.noLogoutBroadcast=true;}if(cV){cg.noDisconnectBroadcast=true;}this.sendToken(cg);}
arguments.callee.inherited.call(this,ax);}else{bj.code= -1;bj.localeKey="jws.jsc.res.notConnected";bj.msg="Not connected.";}}catch(
ex){bj.code= -1;bj.localeKey="jws.jsc.ex";bj.args=[ex.message];bj.msg="Exception on close: "+ex.message;}return bj;},disconnect:
function(ax){return this.close(ax);},setConfiguration:function(fC,fT){var bj=this.checkConnected();if(0===bj.code){for(var dR in fT)
{var dM=fT[dR];if("object"===typeof(dM)){this.setConfiguration(fC+"."+dR,dM);}else{this.sessionPut(fC+"."+dR,dM,false,{});}}}
return bj;}});jws.SystemClientPlugIn={NS:jws.NS_SYSTEM,ALL_CLIENTS:0,AUTHENTICATED:1,NON_AUTHENTICATED:2,PW_PLAIN:null,
PW_ENCODE_MD5:1,PW_MD5_ENCODED:2,processToken:function(aR){if(jws.NS_SYSTEM===aR.ns){if("login"===aR.reqType){if(0===aR.code){if(
...
iE.data);}else{throw "unknown event type: "+iE.type;}this.dispatchEvent(aW);};self.__createSimpleEvent=function(dp){if(
document.createEvent&&window.Event){var aW=document.createEvent("Event");aW.initEvent(dp,false,false);return aW;}else{return{type:
dp,bubbles:false,cancelable:false};}};self.__createMessageEvent=function(bU,aw){if(document.createEvent&&window.MessageEvent&& !
window.opera){var aW=document.createEvent("MessageEvent");aW.initMessageEvent("message",false,false,aw,null,null,window,null);
return aW;}else{return{type:bU,data:aw,bubbles:false,cancelable:false};}};this.__checkPendingMessage=function(){if(
this.__pendingMessages.length>0){var ig=this.__pendingMessages.shift();this.__sendMessage(ig);}};this.open=function(){if(
this.readyState==this.readyStateValues.OPEN)throw "the connection is already opened";else this.__handleConnectionChannel();};
this.keepConnection=function(){this.__handleConnectionChannel();};this.__handleConnectionChannel=function(){var hg=
this.__getXHRTransport();this.__xhr=hg;hg.open("POST",this.url,true);hg.setRequestHeader("Content-Type","application/x-javascript;")
;hg.onreadystatechange=function(){if(hg.readyState>=4){if(hg.status==200){if(hg.responseText){var ia=JSON.parse(hg.responseText);if(
ia.data!=""){setTimeout(function(){for(var cI=0;cI<ia.data.length;cI++){self.__handleEvent({type:"message",data:ia.data[cI]});}},0);
}self.handleConnectionState(ia);if(1==self.readyState){setTimeout(function(){self.keepConnection();},50);}}}}};var ij=
this.__messageFactory({cometType:"connection"});var iD=JSON.stringify(ij);hg.send(iD);};this.__objectMessageBasePrototype=function()
{var ij={subPl:"json",cometType:undefined,data:undefined,readyState:self.readyState};return ij;};this.__sendMessage=function(aw){if(
this.readyState==this.readyStateValues.CONNECTING){throw "The websocket connection has not been stablished";}else if(
this.readyState==this.readyStateValues.CLOSED){
...
"lMethod="+cz.data.method);postMessage(bu(cz.data.args));};jws.APIPlugInClass={NS:jws.NS_BASE+".plugins.api",ID:"api",hasPlugIn:
function(aT,ax){var cg={ns:jws.APIPlugInClass.NS,type:"hasPlugIn",plugin_id:aT};var ct={};if(ax){if(ax.OnResponse){ct.OnResponse=
ax.OnResponse;}}this.conn.sendToken(cg,ct);},getPlugInAPI:function(aT,ax){var cg={ns:jws.APIPlugInClass.NS,type:"getPlugInAPI",
plugin_id:aT};var ct={};if(ax){if(ax.OnResponse){ct.OnResponse=ax.OnResponse;}}this.conn.sendToken(cg,ct);},supportsToken:function(
aT,ax){var cg={ns:jws.APIPlugInClass.NS,type:"supportsToken",token_type:aT};var ct={};if(ax){if(ax.OnResponse){ct.OnResponse=
ax.OnResponse;}}this.conn.sendToken(cg,ct);},getServerAPI:function(ax){var cg={ns:jws.APIPlugInClass.NS,type:"getServerAPI"};var ct=
{};if(ax){if(ax.OnResponse){ct.OnResponse=ax.OnResponse;}}this.conn.sendToken(cg,ct);},getPlugInsIds:function(ax){var cg={ns:
jws.APIPlugInClass.NS,type:"getPlugInIds"};var ct={};if(ax){if(ax.OnResponse){ct.OnResponse=ax.OnResponse;}}this.conn.sendToken(cg,
ct);},createSpecFromAPI:function(eG,cT){var dB=cT.supportedTokens.length;var dx=[];for(var db=0;db<dB;db++){var cg=
cT.supportedTokens[db];cg.ns=cT.namespace;var eN=function(){var cs=false;var cv={ns:cg.ns,type:cg.type};var ek=cg.inArguments;for(
var dy=0,eI=ek.length;dy<eI;dy++){var fx=ek[dy];cv[fx.name]=fx.testValue;}console.log("Automatically sending "+JSON.stringify(cv));
eG.sendToken(cv,{OnResponse:function(aR){console.log("Received auto response: "+JSON.stringify(aR));cs=true;}});waitsFor(function(){
return cs==true;},"test",20000);runs(function(){expect(cs).toEqual(true);});};dx.push(eN);}return dx;}};jws.APIPlugIn=function(){};
jws.APIPlugIn.prototype=jws.APIPlugInClass;jws.CanvasPlugIn={NS:jws.NS_BASE+".plugins.canvas",processToken:function(aR){if(
aR.reqNS==jws.CanvasPlugIn.NS){if("clear"==aR.reqType){this.doClear(aR.id);}else if("beginPath"==aR.reqType){this.doBeginPath(aR.id)
;}else if("moveTo"==aR.reqType){this.doMoveTo(aR.id,aR.x,aR.y);}else if("lineTo"==aR.reqType){this.doLineTo(aR.id,aR.x,aR.y);}
else if("line"==aR.reqType){this.doLine(aR.id,aR.x1,aR.y1,aR.x2,aR.y2,{color:aR.color});}else if("closePath"==aR.reqType){
this.doClosePath(aR.id);}}},bm:{},canvasOpen:function(aT,bL){var bG=jws.$(bL);this.bm[aT]={dj:bG,ctx:bG.getContext("2d")};},
canvasClose:function(aT){this.bm[aT]=null;delete this.bm[aT];},doClear:function(aT){var bh=this.bm[aT];if(bh!=null){var gj=
bh.dj.getAttribute("width");var hE=bh.dj.getAttribute("height");bh.ctx.clearRect(0,0,gj,hE);return true;}return false;},canvasClear:
function(aT){if(this.doClear(aT)){var cg={reqNS:jws.CanvasPlugIn.NS,reqType:"clear",id:aT};this.broadcastToken(cg);}},
canvasGetBase64:function(aT,eB){var bj={code: -1,msg:"Ok"};var bh=this.bm[aT];if(bh!=null){if(typeof bh.dj.toDataURL=="function"){
bj.code=0;bj.encoding="base64";bj.data=bh.dj.toDataURL(eB);}else{bj.msg=
"Retrieving image data from canvas not (yet) supported by browser.";}}else{bj.msg="Canvas not found.";}return bj;},doBeginPath:
function(aT){var bh=this.bm[aT];if(bh!=null){bh.ctx.beginPath();return true;}return false;},canvasBeginPath:function(aT){if(
this.doBeginPath(aT)){var cg={reqNS:jws.CanvasPlugIn.NS,reqType:"beginPath",id:aT};this.broadcastToken(cg);}},doMoveTo:function(aT,
cA,cj){var bh=this.bm[aT];if(bh!=null){bh.ctx.moveTo(cA,cj);return true;}return false;},canvasMoveTo:function(aT,cA,cj){if(
this.doMoveTo(aT,cA,cj)){var cg={reqNS:jws.CanvasPlugIn.NS,reqType:"moveTo",id:aT,x:cA,y:cj};this.broadcastToken(cg);}},doLineTo:
function(aT,cA,cj){var bh=this.bm[aT];if(bh!=null){bh.ctx.lineTo(cA,cj);bh.ctx.stroke();return true;}return false;},canvasLineTo:
function(aT,cA,cj){if(this.doLineTo(aT,cA,cj)){var cg={reqNS:jws.CanvasPlugIn.NS,reqType:"lineTo",id:aT,x:cA,y:cj};
this.broadcastToken(cg);}},doLine:function(aT,cn,dk,cy,dq,ax){if(undefined==ax){ax={};}var ce="black";if(ax.color){ce=ax.color;}
var bh=this.bm[aT];if(bh!=null){bh.ctx.beginPath();bh.ctx.moveTo(cn,dk);bh.ctx.strokeStyle=ce;bh.ctx.lineTo(cy,dq);bh.ctx.stroke();
bh.ctx.closePath();return true;}return false;},canvasLine:function(aT,cn,dk,cy,dq,ax){if(undefined==ax){ax={};}var ce="black";if(
ax.color){ce=ax.color;}if(this.doLine(aT,cn,dk,cy,dq,ax)){var cg={reqNS:jws.CanvasPlugIn.NS,reqType:"line",id:aT,x1:cn,y1:dk,x2:cy,
y2:dq,color:ce};this.broadcastToken(cg);}},doClosePath:function(aT){var bh=this.bm[aT];if(bh!=null){bh.ctx.closePath();return true;}
return false;},canvasClosePath:function(aT){if(this.doClosePath(aT)){var cg={reqNS:jws.CanvasPlugIn.NS,reqType:"closePath",id:aT};
this.broadcastToken(cg);}}};jws.oop.addPlugIn(jws.jWebSocketTokenClient,jws.CanvasPlugIn);if(jws.isIE){
	//
	//	-------------------------------------------------------------------------------
	//	ExplorerCanvas
	//
...
ax.name;}if(ax["newSecretKey"]){cg.newSecretKey=ax.newSecretKey;}if(ax["accessKey"]){cg.accessKey=ax.accessKey;}if(ax["owner"]){
cg.owner=ax.owner;}if(undefined!=ax["isPrivate"]){cg.isPrivate=ax.isPrivate;}if(undefined!=ax["isSystem"]){cg.isSystem=ax.isSystem;}
this.sendToken(cg,ax);}return bj;},channelCreate:function(aT,ev,ax){var bj=this.checkConnected();if(0==bj.code){var eV=false;var cL=
false;var cd=null;var cP=null;var cG=null;var dP=null;if(ax){if(ax.isPrivate!=undefined){eV=ax.isPrivate;}if(ax.isSystem!=undefined)
{cL=ax.isSystem;}if(ax.accessKey!=undefined){cd=ax.accessKey;}if(ax.secretKey!=undefined){cP=ax.secretKey;}if(ax.owner!=undefined){
cG=ax.owner;}if(ax.password!=undefined){dP=ax.password;}}this.sendToken({ns:jws.ChannelPlugIn.NS,type:
jws.ChannelPlugIn.CREATE_CHANNEL,channel:aT,name:ev,isPrivate:eV,isSystem:cL,accessKey:cd,secretKey:cP,owner:cG,password:dP},ax);}
return bj;},channelRemove:function(aT,ax){var bj=this.checkConnected();if(0==bj.code){var cd=null;var cP=null;var cG=null;var dP=
null;if(ax){if(ax.accessKey!=undefined){cd=ax.accessKey;}if(ax.secretKey!=undefined){cP=ax.secretKey;}if(ax.owner!=undefined){cG=
ax.owner;}if(ax.password!=undefined){dP=ax.password;}}this.sendToken({ns:jws.ChannelPlugIn.NS,type:jws.ChannelPlugIn.REMOVE_CHANNEL,
channel:aT,accessKey:cd,secretKey:cP,owner:cG,password:dP},ax);}return bj;},channelGetSubscribers:function(dC,dN,ax){var bj=
this.checkConnected();if(0==bj.code){this.sendToken({ns:jws.ChannelPlugIn.NS,type:jws.ChannelPlugIn.GET_SUBSCRIBERS,channel:dC,
accessKey:dN},ax);}return bj;},channelGetPublishers:function(dC,dN,ax){var bj=this.checkConnected();if(0==bj.code){this.sendToken({
ns:jws.ChannelPlugIn.NS,type:jws.ChannelPlugIn.GET_PUBLISHERS,channel:dC,accessKey:dN},ax);}return bj;},channelGetSubscriptions:
function(ax){var bj=this.checkConnected();if(0==bj.code){this.sendToken({ns:jws.ChannelPlugIn.NS,type:
...
ci.OnExtProcessMsg;}}};jws.oop.addPlugIn(jws.jWebSocketTokenClient,jws.ExtProcessPlugIn);jws.FileSystemPlugIn={NS:jws.NS_BASE+
".plugins.filesystem",ALIAS_PRIVATE:"privateDir",ALIAS_PUBLIC:"publicDir",NOT_FOUND_ERR:1,SECURITY_ERR:2,ABORT_ERR:3,
NOT_READABLE_ERR:4,ENCODING_ERR:5,NO_MODIFICATION_ALLOWED_ERR:6,INVALID_STATE_ERR:7,SYNTAX_ERR:8,INVALID_MODIFICATION_ERR:9,
QUOTA_EXCEEDED_ERR:10,TYPE_MISMATCH_ERR:11,PATH_EXISTS_ERR:12,processToken:function(aR){if(aR.ns===jws.FileSystemPlugIn.NS){if(
"load"===aR.reqType){if(0===aR.code){if(this.OnFileLoaded){this.OnFileLoaded(aR);}}else{if(this.OnFileError){this.OnFileError(aR);}}
}else if("send"===aR.reqType){if(0===aR.code){if(this.OnFileSent){this.OnFileSent(aR);}}else{if(this.OnFileError){this.OnFileError(
aR);}}}else if("event"===aR.type){if("filesaved"===aR.name){if(this.OnFileSaved){this.OnFileSaved(aR);}}else if("filereceived"===
aR.name){if(this.OnFileReceived){this.OnFileReceived(aR);}}else if("filedeleted"===aR.name){if(this.OnFileDeleted){
this.OnFileDeleted(aR);}}}}},fileGetFilelist:function(hJ,hd,ax){var bj=this.checkConnected();if(0===bj.code){ax=jws.getOptions(ax,{
path:null,recursive:false,includeDirs:false});var cg={ns:jws.FileSystemPlugIn.NS,type:"getFilelist",alias:hJ,recursive:ax.recursive,
includeDirs:ax.includeDirs,filemasks:hd,path:ax.path};this.sendToken(cg,ax);}return bj;},fileDelete:function(bB,fR,ax){ax=
jws.getOptions(ax,{scope:jws.SCOPE_PRIVATE,notify:false});var bj=this.checkConnected();if(0===bj.code){var cg={ns:
jws.FileSystemPlugIn.NS,type:"delete",filename:bB,force:fR,notify:(jws.SCOPE_PUBLIC===ax.scope)&&ax.notify,scope:ax.scope};if(
"undefined"!==typeof ax.alias){cg.alias=ax.alias;}this.sendToken(cg,ax);}return bj;},fileExists:function(bB,hJ,ax){var bj=
this.checkConnected();if(0===bj.code){var cg={ns:jws.FileSystemPlugIn.NS,type:"exists",filename:bB,alias:hJ};this.sendToken(cg,ax);}
return bj;},fileLoad:function(bB,hJ,ax){var bj=this.createDefaultResult();ax=jws.getOptions(ax,{encoding:"base64"});if(
this.isConnected()){var cg={ns:jws.FileSystemPlugIn.NS,type:"load",alias:hJ,filename:bB};if(ax.encoding){cg.encoding=ax.encoding;}
this.sendToken(cg,ax);}else{bj.code= -1;bj.localeKey="jws.jsc.res.notConnected";bj.msg="Not connected.";}return bj;},mFileWrite:
function(bB,aw,ax){var bj=this.createDefaultResult();ax=jws.getOptions(ax,{encoding:"base64",encode:true,notify:false,scope:
jws.SCOPE_PRIVATE});var dp=null;if(ax.append){dp="append";}else{dp="save";}if(!dp){bj.code= -1;bj.msg=
"No save/append option passed.";return bj;}var ji={};if(ax.encode){ji.data=ax.encoding;}if(this.isConnected()){var cg={ns:
...
return this.mFileWrite(bB,aw,ax);},fileAppend:function(bB,aw,ax){if(!ax){ax={};}ax.append=true;return this.mFileWrite(bB,aw,ax);},
fileSend:function(dW,bB,aw,ax){var dY=false;var bs="base64";var gV=true;if(ax){bs=ax["encoding"]||"base64";if(ax.isNode!==undefined)
{dY=ax.isNode;}if(ax.encode!==undefined){gV=ax.encode;}}var bj=this.checkConnected();if(0===bj.code){var ji={};if(gV){ji.data=bs;}
var cg={ns:jws.FileSystemPlugIn.NS,type:"send",data:aw,enc:ji,encode:gV,encoding:bs,filename:bB};if(dY){cg.unid=dW;}else{
cg.targetId=dW;}this.sendToken(cg,ax);}return bj;},fileGetErrorMsg:function(eY){var dm="unkown";switch(eY){
case jws.FileSystemPlugIn.NOT_FOUND_ERR:{dm="NOT_FOUND_ERR";break;}case jws.FileSystemPlugIn.SECURITY_ERR:{dm="SECURITY_ERR";break;}
case jws.FileSystemPlugIn.ABORT_ERR:{dm="ABORT_ERR";break;}case jws.FileSystemPlugIn.NOT_READABLE_ERR:{dm="NOT_READABLE_ERR";break;}
case jws.FileSystemPlugIn.ENCODING_ERR:{dm="ENCODING_ERR";break;}case jws.FileSystemPlugIn.NO_MODIFICATION_ALLOWED_ERR:{dm=
"NO_MODIFICATION_ALLOWED_ERR";break;}case jws.FileSystemPlugIn.INVALID_STATE_ERR:{dm="INVALID_STATE_ERR";break;}
case jws.FileSystemPlugIn.SYNTAX_ERR:{dm="SYNTAX_ERR";break;}case jws.FileSystemPlugIn.INVALID_MODIFICATION_ERR:{dm=
"INVALID_MODIFICATION_ERR";break;}case jws.FileSystemPlugIn.QUOTA_EXCEEDED_ERR:{dm="QUOTA_EXCEEDED_ERR";break;}
case jws.FileSystemPlugIn.TYPE_MISMATCH_ERR:{dm="TYPE_MISMATCH_ERR";break;}case jws.FileSystemPlugIn.PATH_EXISTS_ERR:{dm=
"PATH_EXISTS_ERR";break;}}return dm;},fileLoadLocal:function(ds,ax){var bj={code:0,msg:"ok"};if(!ds|| !ds.files){return{code: -1,
msg:"No input file element passed."};}if(undefined===window.FileReader){return{code: -1,msg:
"Your browser does not yet support the HTML5 File API."};}if(!ax){ax={};}ax.encoding="base64";var cH=ds.files;if(!cH|| !cH.length){
return{code: -1,msg:"No files selected."};}for(var db=0,dB=cH.length;db<dB;db++){var dw=cH[db];var dh=new FileReader();var dJ=this;
dh.onload=(function(cw){return function(cz){if(dJ.OnLocalFileRead||ax.OnSuccess){var cg={encoding:ax.encoding,fileName:(cw.fileName?
cw.fileName:cw.name),fileSize:(cw.fileSize?cw.fileSize:cw.size),type:cw.type,lastModified:cw.lastModifiedDate,data:cz.target.result}
;if(ax.args){cg.args=ax.args;}if(ax.action){cg.action=ax.action;}}if(dJ.OnLocalFileRead){dJ.OnLocalFileRead(cg);}if(ax.OnSuccess){
ax.OnSuccess(cg);}};})(dw);dh.onerror=(function(cw){return function(cz){if(dJ.OnLocalFileError||ax.OnFailure){var dn=
cz.target.error.code;var cg={code:dn,msg:dJ.fileGetErrorMsg(dn)};if(ax.args){cg.args=ax.args;}if(ax.action){cg.action=ax.action;}}
if(dJ.OnLocalFileError){dJ.OnLocalFileError(cg);}if(ax.OnFailure){ax.OnFailure(cg);}};})(dw);try{dh.readAsDataURL(dw);}catch(dQ){if(
dJ.OnLocalFileError||ax.OnFailure){var cg={code: -1,msg:dQ.message};if(ax.args){cg.args=ax.args;}if(ax.action){cg.action=ax.action;}
}if(dJ.OnLocalFileError){dJ.OnLocalFileError(cg);}if(ax.OnFailure){ax.OnFailure(cg);}}}return bj;},setFileSystemCallbacks:function(
ci){if(!ci){ci={};}if(ci.OnFileLoaded!==undefined){this.OnFileLoaded=ci.OnFileLoaded;}if(ci.OnFileSaved!==undefined){
this.OnFileSaved=ci.OnFileSaved;}if(ci.OnFileDeleted!==undefined){this.OnFileDeleted=ci.OnFileDeleted;}if(ci.OnFileReceived!==
undefined){this.OnFileReceived=ci.OnFileReceived;}if(ci.OnFileSent!==undefined){this.OnFileSent=ci.OnFileSent;}if(ci.OnFileError!==
undefined){this.OnFileError=ci.OnFileError;}if(ci.OnLocalFileRead!==undefined){this.OnLocalFileRead=ci.OnLocalFileRead;}if(
ci.OnLocalFileError!==undefined){this.OnLocalFileError=ci.OnLocalFileError;}}};jws.oop.addPlugIn(jws.jWebSocketTokenClient,
jws.FileSystemPlugIn);jws.ioc={};jws.ioc.ServiceReference=function ServiceReference(ev){this._name=ev;};
jws.ioc.ServiceReference.prototype.getName=function(){return this._name;};jws.ioc.ParameterReference=function ParameterReference(ev)
{this._name=ev;};jws.ioc.ParameterReference.prototype.getName=function(){return this._name;};jws.ioc.DOMReference=
function DOMReference(aT){this._id=aT;};jws.ioc.DOMReference.prototype.getId=function(){return this._id;};
...
;jws.sc=new jws.ioc.ServiceContainerBuilder({id:"jws.sc",container:new jws.ioc.ServiceContainer()});jws.ItemStoragePlugIn={NS:
jws.NS_BASE+".plugins.itemstorage",processToken:function(aR){if(aR.ns==jws.ItemStoragePlugIn.NS){if("event"==aR.type){if(
"itemSaved"==aR.name){if(this.OnItemSaved){this.OnItemSaved(aR);}}else if("itemRemoved"==aR.name){if(this.OnItemRemoved){
this.OnItemRemoved(aR);}}else if("collectionCleaned"==aR.name){if(this.OnCollectionCleaned){this.OnCollectionCleaned(aR);}}else if(
"collectionRestarted"==aR.name){if(this.OnCollectionRestarted){this.OnCollectionRestarted(aR);}}else if("collectionRemoved"==
aR.name){if(this.OnCollectionRemoved){this.OnCollectionRemoved(aR);}}else if("collectionSaved"==aR.name){if(this.OnCollectionSaved){
this.OnCollectionSaved(aR);}}else if("authorization"==aR.name){if(this.OnCollectionAuthorization){this.OnCollectionAuthorization(aR)
;}}else if("subscription"==aR.name){if(this.OnCollectionSubscription){this.OnCollectionSubscription(aR);}}else if("unsubscription"==
aR.name){if(this.OnCollectionUnsubscription){this.OnCollectionUnsubscription(aR);}}}}},createCollection:function(iv,ix,hZ,iK,iy,ax){
var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:"createCollection",collectionName:iv,itemType:
ix,secretPassword:hZ,accessPassword:iK,"private":iy};if(ax.capacity){cg.capacity=ax.capacity;}if(ax.capped){cg.capped=ax.capped;}
...
secretPassword:hZ};this.sendToken(cg,ax);}return bj;},clearCollection:function(iv,hZ,ax){var bj=this.checkConnected();if(0==bj.code)
{var cg={ns:jws.ItemStoragePlugIn.NS,type:"clearCollection",collectionName:iv,secretPassword:hZ};this.sendToken(cg,ax);}return bj;},
editCollection:function(iv,hZ,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:
"editCollection",collectionName:iv,secretPassword:hZ};if(ax.newSecretPassword){cg.newSecretPassword=ax.newSecretPassword;}if(
ax.accessPassword){cg.accessPassword=ax.accessPassword;}if(ax["private"]){cg["private"]=ax["private"];}if(ax.capped){cg.capped=
...
findItemByPK:function(iv,jc,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:"findItemByPK",
collectionName:iv,itemPK:jc};this.sendToken(cg,ax);}return bj;},existsItem:function(iv,jc,ax){var bj=this.checkConnected();if(0==
bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:"existsItem",collectionName:iv,itemPK:jc};this.sendToken(cg,ax);}return bj;},
listItems:function(iv,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:"listItems",
collectionName:iv,offset:ax["offset"]||0,length:ax["length"]||10};this.sendToken(cg,ax);}return bj;},findItemDefinition:function(ix,
ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:"findDefinition",itemType:ix};
this.sendToken(cg,ax);}return bj;},existsItemDefinition:function(ix,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:
jws.ItemStoragePlugIn.NS,type:"existsDefinition",itemType:ix};this.sendToken(cg,ax);}return bj;},listItemDefinitions:function(ax){
var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ItemStoragePlugIn.NS,type:"listDefinitions",offset:ax["offset"]||0,
length:ax["length"]||10};this.sendToken(cg,ax);}return bj;},setItemStorageCallbacks:function(ci){if(!ci){ci={};}if(ci.OnItemSaved!==
undefined){this.OnItemSaved=ci.OnItemSaved;}if(ci.OnItemRemoved!==undefined){this.OnItemRemoved=ci.OnItemRemoved;}if(
ci.OnCollectionCleaned!==undefined){this.OnCollectionCleaned=ci.OnCollectionCleaned;}if(ci.OnCollectionRestarted!==undefined){
this.OnCollectionRestarted=ci.OnCollectionRestarted;}if(ci.OnCollectionRemoved!==undefined){this.OnCollectionRemoved=
ci.OnCollectionRemoved;}if(ci.OnCollectionSaved!==undefined){this.OnCollectionSaved=ci.OnCollectionSaved;}if(
ci.OnCollectionSubscription!==undefined){this.OnCollectionSubscription=ci.OnCollectionSubscription;}if(
...
IDENTIFY:"identify",processToken:function(aR){if(aR.ns===jws.JMSPlugIn.NS_JMS_GATEWAY){if("response"===aR.type){if("ping"===
aR.reqType){if(this.OnPing){this.OnPing(aR);}}else if("identify"===aR.reqType){if(this.OnIdentify){this.OnIdentify(aR);}}}}else if(
aR.ns===jws.JMSPlugIn.NS){if("event"===aR.type){if("handleJmsText"===aR.name){if(this.OnHandleJmsText){this.OnHandleJmsText(aR);}}
else if("handleJmsTextMessage"===aR.name){if(this.OnHandleJmsTextMessage){this.OnHandleJmsTextMessage(aR);}}else if(
"handleJmsMap"===aR.name){if(this.OnHandleJmsMap){this.OnHandleJmsMap(aR);}}else if("handleJmsMapMessage"===aR.name){if(
this.OnHandleJmsMapMessage){this.OnHandleJmsMapMessage(aR);}}}}},jmsPing:function(dW,ax){var bj=this.checkConnected();if(0===
bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:jws.JMSPlugIn.PING,targetId:dW},ax);}return bj;},jmsIdentify:function(dW,ax){
var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:jws.JMSPlugIn.IDENTIFY,targetId:dW},ax);}
return bj;},jmsEcho:function(dW,aPayload,ax){var bj=this.checkConnected();if(0===bj.code){this.forwardJSON(dW,
jws.JMSPlugIn.NS_JMS_DEMO,"echo",{},aPayload,ax);}return bj;},listenJms:function(fg,et,fG,ax){var bj=this.checkConnected();if(0===
bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:jws.JMSPlugIn.LISTEN,connectionFactoryName:fg,destinationName:et,pubSubDomain:fG},
ax);}return bj;},listenJmsMessage:function(fg,et,fG,ax){var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:
jws.JMSPlugIn.NS,type:jws.JMSPlugIn.LISTEN_MESSAGE,connectionFactoryName:fg,destinationName:et,pubSubDomain:fG},ax);}return bj;},
unlistenJms:function(fg,et,fG,ax){var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:
jws.JMSPlugIn.UNLISTEN,connectionFactoryName:fg,destinationName:et,pubSubDomain:fG},ax);}return bj;},sendJmsText:function(fg,et,fG,
aB,ax){var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:jws.JMSPlugIn.SEND_TEXT,
connectionFactoryName:fg,destinationName:et,pubSubDomain:fG,msgPayLoad:aB},ax);}return bj;},sendJmsTextMessage:function(fg,et,fG,aB,
gm,ax){var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:jws.JMSPlugIn.SEND_TEXT_MESSAGE,
connectionFactoryName:fg,destinationName:et,pubSubDomain:fG,msgPayLoad:aB,jmsHeaderProperties:gm},ax);}return bj;},sendJmsMap:
function(fg,et,fG,hI,ax){var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:
jws.JMSPlugIn.SEND_MAP,connectionFactoryName:fg,destinationName:et,pubSubDomain:fG,msgPayLoad:hI},ax);}return bj;},
sendJmsMapMessage:function(fg,et,fG,hI,gm,ax){var bj=this.checkConnected();if(0===bj.code){this.sendToken({ns:jws.JMSPlugIn.NS,type:
jws.JMSPlugIn.SEND_MAP_MESSAGE,connectionFactoryName:fg,destinationName:et,pubSubDomain:fG,msgPayLoad:hI,jmsHeaderProperties:gm},ax)
;}return bj;},setJMSCallbacks:function(ci){if(!ci){ci={};}if(ci.OnHandleJmsText!==undefined){this.OnHandleJmsText=
ci.OnHandleJmsText;}if(ci.OnHandleJmsTextMessage!==undefined){this.OnHandleJmsTextMessage=ci.OnHandleJmsTextMessage;}if(
ci.OnHandleJmsMap!==undefined){this.OnHandleJmsMap=ci.OnHandleJmsMap;}if(ci.OnHandleJmsMapMessage!==undefined){
this.OnHandleJmsMapMessage=ci.OnHandleJmsMapMessage;}if(ci.OnPing!==undefined){this.OnPing=ci.OnPing;}if(ci.OnIdentify!==undefined){
this.OnIdentify=ci.OnIdentify;}}};jws.oop.addPlugIn(jws.jWebSocketTokenClient,jws.JMSPlugIn);jws.LoggingPlugIn={NS:jws.NS_BASE+
...
jws.MailPlugIn={NS:jws.NS_BASE+".plugins.mail",HTML_MAIL:true,TEXT_MAIL:false,processToken:function(aR){if(aR.ns==jws.MailPlugIn.NS)
{if("sendMail"==aR.reqType){if(this.OnMailSent){this.OnMailSent(aR);}}else if("createMail"==aR.reqType){if(this.OnMailCreated){
this.OnMailCreated(aR);}}}},sendMail:function(aT,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.MailPlugIn.NS,type:
"sendMail",id:aT};this.sendToken(cg,ax);}return bj;},createMail:function(bN,bV,bS,bQ,bW,bP,bY,ax){var bj=this.checkConnected();if(
0==bj.code){var cg={ns:jws.MailPlugIn.NS,type:"createMail",from:bN,to:bV,cc:bS,bcc:bQ,subject:bW,body:bP,isHTML:bY};this.sendToken(
cg,ax);}return bj;},dropMail:function(aT,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.MailPlugIn.NS,type:
"dropMail",id:aT};this.sendToken(cg,ax);}return bj;},addAttachment:function(aT,bB,aw,ax){var bj=this.checkConnected();if(0==bj.code)
{var bs="base64";var bD=false;var bt=jws.SCOPE_PRIVATE;var fX=null;var gS=null;if(ax){if(ax.scope!=undefined){bt=ax.scope;}if(
ax.encoding!=undefined){bs=ax.encoding;}if(ax.suppressEncoder!=undefined){bD=ax.suppressEncoder;}if(ax.volumeSize!=undefined){fX=
ax.volumeSize;}if(ax.archiveName!=undefined){gS=ax.archiveName;}}if(!bD){if(bs=="base64"){aw=Base64.encode(aw);}}var cg={ns:
jws.MailPlugIn.NS,type:"addAttachment",encoding:bs,id:aT,data:aw,filename:bB};if(fX){cg.volumeSize=fX;}if(gS){cg.archiveName=gS;}
this.sendToken(cg,ax);}return bj;},removeAttachment:function(aT,ax){},getMail:function(aT,ax){},moveMail:function(aT,ax){},
setMailCallbacks:function(ci){if(!ci){ci={};}if(ci.OnMailSent!==undefined){this.OnMailSent=ci.OnMailSent;}if(ci.OnMailCreated!==
undefined){this.OnMailCreated=ci.OnMailCreated;}}};jws.oop.addPlugIn(jws.jWebSocketTokenClient,jws.MailPlugIn);jws.ReportingPlugIn={
NS:jws.NS_BASE+".plugins.reporting",processToken:function(aR){if(aR.ns==jws.ReportingPlugIn.NS){if("generateReport"==aR.reqType){if(
this.OnReport){this.OnReport(aR);}}else if("getReports"==aR.reqType){if(this.OnReports){this.OnReports(aR);}}else if(
"uploadTemplate"==aR.reqType){if(this.OnUploadTemplate){this.OnUploadTemplate(aR);}}}},reportingGenerateReport:function(gE,fT,aM,ax)
{var bj=this.checkConnected();if(0==bj.code){if(!ax){ax={};}var cg={ns:jws.ReportingPlugIn.NS,type:"generateReport",reportName:gE,
reportFields:aM,reportParams:fT,reportOutputType:ax.outputType||"pdf",useJDBCConnection:ax.useConection||false,nameJDBCCOnnection:
ax.nameConnection||""};this.sendToken(cg,ax);}return bj;},reportingGetReports:function(ax){var bj=this.checkConnected();if(0==
bj.code){var cg={ns:jws.ReportingPlugIn.NS,type:"getReports"};this.sendToken(cg,ax);}return bj;},reportingUploadTemplate:function(
gw,ax){var bj=this.checkConnected();if(0==bj.code){var cg={ns:jws.ReportingPlugIn.NS,type:"uploadTemplate",templatePath:gw};
this.sendToken(cg,ax);}return bj;},setReportingCallbacks:function(ci){if(!ci){ci={};}if(ci.OnReport!==undefined){this.OnReport=
ci.OnReport;}if(ci.OnReports!==undefined){this.OnReports=ci.OnReports;}if(ci.OnUploadTemplate!==undefined){this.OnUploadTemplate=
