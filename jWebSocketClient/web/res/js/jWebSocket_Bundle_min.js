...
//	---------------------------------------------------------------------------
if(window.jd){window.WebSocket=window.jd;}var jws={VERSION:"1.0b8 (nightly build 20503)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,fW:1000,jR:1001,jo:{eZ:false,jv: -1,iP: -1,hJ: -1,gA: -1},kC:{eZ:true,jv:2000,iP:30000,hJ:1000,gA:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kF:"org.jwebsocket.text",lx:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,jq:0,gK:1,gw:2,ge:3,gi:4,he:5,hP:6,eJ:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],ko:"guest",kA:"guest",kN:"root",jc:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),iI:function(){return this.dX;},gE:function(){return this.eU;},hR:function(){return this.fG;},isFirefox:function(){return this.gr;},jB:function(){return this.hD;},iW:function(){return this.hj;},fZ:function(){return this.fT;},iT:function(){return(this.fZ()&&this.gE()<7);},ih:function(){return(this.fZ()&&this.gE()<8);},hN:function(){return(this.fZ()&&this.gE()>=8);},jw:function(){return this.fV;},iH:function(){return this.hC;},is:function(){return this.gF;},console:{dS:false,ee:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,fU:function(){return(window.console&&jws.console.dS&&jws.console.ee<=jws.console.DEBUG);},io:function(){return(window.console&&jws.console.dS&&jws.console.ee<=jws.console.INFO);},log:function(eW){if(window.console&&jws.console.dS){console.log(eW);}},fq:function(eW){if(window.console&&jws.console.dS&&jws.console.ee<=jws.console.DEBUG){if(console.fq){console.fq(eW);}else{console.log("[fq]: "+eW);}}},info:function(eW){if(window.console&&jws.console.dS&&jws.console.ee<=jws.console.INFO){if(console.info){console.info(eW);}else{console.log("[info]: "+eW);}}},hA:function(eW){if(window.console&&jws.console.dS&&jws.console.ee<=jws.console.WARN){if(console.hA){console.hA(eW);}else{console.log("[hA]: "+eW);}}},error:function(eW){if(window.console&&jws.console.dS&&jws.console.ee<=jws.console.ERROR){if(console.error){console.error(eW);}else{console.log("[error]: "+eW);}}},hw:function(eW){if(window.console&&jws.console.dS&&jws.console.ee<=jws.console.FATAL){if(console.hw){console.hw(eW);}else{console.log("[hw]: "+eW);}}},jW:function(){return jws.console.ee;},lg:function(fo){jws.console.ee=fo;},isActive:function(){return jws.console.dS;},setActive:function(eq){jws.console.dS=eq;}}};(function(){jws.dX="unknown";jws.fI=jws.jq;jws.eU=undefined;jws.fT=false;jws.gr=false;jws.hC=false;jws.hD=false;jws.fV=false;jws.hj=false;var eK=navigator.userAgent;jws.hj=eK.indexOf("Chrome")>=0;if(jws.hj){jws.fI=jws.hP;}else{jws.fV=eK.indexOf("Safari")>=0;if(jws.fV){jws.fI=jws.he;}else{jws.hC=eK.indexOf("Netscape")>=0;if(jws.hC){jws.fI=jws.gw;}else{jws.gr=navigator.appName=="Netscape";if(jws.gr){jws.fI=jws.gK;}else{jws.hD=navigator.appName=="Opera";if(jws.hD){jws.fI=jws.ge;}else{jws.fT=navigator.appName=="Microsoft Internet Explorer";if(jws.fT){jws.fI=jws.gi;}else{jws.gF=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gF){jws.fI=jws.gi;}}}}}}}var p,i;var aJ;var en;var ac;if(jws.fT){jws.dX=jws.eJ[jws.gi];ac=eK.match(/MSIE.*/i);if(ac){aJ=ac[0].substr(5);p=aJ.indexOf(";");jws.fG=p>0?aJ.substr(0,p):aJ;jws.eU=parseFloat(jws.fG);}}else if(jws.gr){jws.dX=jws.eJ[jws.gK];ac=eK.match(/Firefox\/.*/i);if(ac){aJ=ac[0].substr(8);p=aJ.indexOf(" ");if(p>0){jws.fG=aJ.substring(0,p);}else{jws.fG=aJ;}en=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){en++;}if(en>=2){break;}i++;}aJ=aJ.substring(0,i);jws.eU=parseFloat(aJ);}}else if(jws.hC){jws.dX=jws.eJ[jws.gw];ac=eK.match(/Netscape\/.*/i);if(ac){aJ=ac[0].substr(9);p=aJ.indexOf(" ");if(p>0){jws.fG=aJ.substring(0,p);}else{jws.fG=aJ;}en=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){en++;}if(en>=2){break;}i++;}aJ=aJ.substring(0,i);jws.eU=parseFloat(aJ);}}else if(jws.hD){jws.dX=jws.eJ[jws.ge];ac=eK.match(/Opera\/.*/i);if(ac){aJ=ac[0].substr(6);p=aJ.indexOf(" ");jws.fG=p>0?aJ.substr(0,p):aJ;jws.eU=parseFloat(aJ);ac=eK.match(/Version\/.*/i);aJ=ac[0].substr(8);if(ac){p=aJ.indexOf(" ");jws.fG=(p>0?aJ.substr(0,p):aJ)+"/"+jws.fG;jws.eU=parseFloat(aJ);}}}else if(jws.hj){jws.dX=jws.eJ[jws.hP];ac=eK.match(/Chrome\/.*/i);if(ac){aJ=ac[0].substr(7);p=aJ.indexOf(" ");jws.fG=p>0?aJ.substr(0,p):aJ;jws.eU=parseFloat(aJ);}}else if(jws.fV){jws.dX=jws.eJ[jws.he];ac=eK.match(/Version\/.*/i);if(ac){aJ=ac[0].substr(8);p=aJ.indexOf(" ");jws.fG=p>0?aJ.substr(0,p):aJ;en=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){en++;}if(en>=2){break;}i++;}aJ=aJ.substring(0,i);jws.eU=parseFloat(aJ);ac=eK.match(/Safari\/.*/i);if(ac){aJ="."+ac[0].substr(7);p=aJ.indexOf(" ");jws.fG+=p>0?aJ.substr(0,p):aJ;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},jZ:function(je){if(je&&typeof ck=="string"){}return je;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},kB:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},ka:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},lA:function(ey,gI,il){var iK=il||"";var hF=null;var eE=null;for(eE in gI){hF="set"+eE.substr(0,1).toUpperCase()+eE.substr(1);if(typeof(ey[hF])=="function"){ey[hF](gI[eE]);}else{ey[iK+eE]=gI[eE];}}return ey;},gz:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gz"])){return ey.gz();}if(ey instanceof Date){return new Date(ey.getTime());}var iD=function(gb){var gu=gb.length;var gR=[];if(gu>0){for(var cf=0;cf<gu;cf++){gR[cf]=jws.tools.gz(gb[cf]);}}return gR;};var dH=new ey.constructor();for(var hb in ey){var dM=ey[hb];if(dM instanceof Array)dH[hb]=iD(dM);else{dH[hb]=jws.tools.gz(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
