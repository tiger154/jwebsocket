...
//	---------------------------------------------------------------------------
if(window.hL){window.WebSocket=window.hL;}var jws={VERSION:"1.0b6 (nightly build 20416)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,fO:1000,lo:1001,hV:{fA:false,gN: -1,jp: -1,fX: -1,gp: -1},jN:{fA:true,gN:2000,jp:30000,fX:1000,gp:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kr:"org.jwebsocket.text",lf:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,iV:0,fY:1,gi:2,gG:3,gu:4,gl:5,jv:6,fq:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],jU:"guest",jR:"guest",ld:"root",le:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),jw:function(){return this.fk;},hH:function(){return this.eH;},ik:function(){return this.eO;},isFirefox:function(){return this.fP;},iG:function(){return this.fZ;},ka:function(){return this.hn;},fU:function(){return this.ho;},hO:function(){return(this.fU()&&this.hH()<7);},iD:function(){return(this.fU()&&this.hH()<8);},lz:function(){return(this.fU()&&this.hH()>=8);},jt:function(){return this.hw;},iX:function(){return this.hB;},iu:function(){return this.hv;},console:{ef:false,fM:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,gL:function(){return(window.console&&jws.console.ef&&jws.console.fM<=jws.console.DEBUG);},jy:function(){return(window.console&&jws.console.ef&&jws.console.fM<=jws.console.INFO);},log:function(eJ){if(window.console&&jws.console.ef){console.log(eJ);}},fI:function(eJ){if(window.console&&jws.console.ef&&jws.console.fM<=jws.console.DEBUG){if(console.fI){console.fI(eJ);}else{console.log("[fI]: "+eJ);}}},info:function(eJ){if(window.console&&jws.console.ef&&jws.console.fM<=jws.console.INFO){if(console.info){console.info(eJ);}else{console.log("[info]: "+eJ);}}},hI:function(eJ){if(window.console&&jws.console.ef&&jws.console.fM<=jws.console.WARN){if(console.hI){console.hI(eJ);}else{console.log("[hI]: "+eJ);}}},error:function(eJ){if(window.console&&jws.console.ef&&jws.console.fM<=jws.console.ERROR){if(console.error){console.error(eJ);}else{console.log("[error]: "+eJ);}}},gb:function(eJ){if(window.console&&jws.console.ef&&jws.console.fM<=jws.console.FATAL){if(console.gb){console.gb(eJ);}else{console.log("[gb]: "+eJ);}}},lg:function(){return jws.console.fM;},jH:function(fo){jws.console.fM=fo;},isActive:function(){return jws.console.ef;},setActive:function(eq){jws.console.ef=eq;}}};(function(){jws.fk="unknown";jws.fL=jws.iV;jws.eH=undefined;jws.ho=false;jws.fP=false;jws.hB=false;jws.fZ=false;jws.hw=false;jws.hn=false;var fE=navigator.userAgent;jws.hn=fE.indexOf("Chrome")>=0;if(jws.hn){jws.fL=jws.jv;}else{jws.hw=fE.indexOf("Safari")>=0;if(jws.hw){jws.fL=jws.gl;}else{jws.hB=fE.indexOf("Netscape")>=0;if(jws.hB){jws.fL=jws.gi;}else{jws.fP=navigator.appName=="Netscape";if(jws.fP){jws.fL=jws.fY;}else{jws.fZ=navigator.appName=="Opera";if(jws.fZ){jws.fL=jws.gG;}else{jws.ho=navigator.appName=="Microsoft Internet Explorer";if(jws.ho){jws.fL=jws.gu;}else{jws.hv=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.hv){jws.fL=jws.gu;}}}}}}}var p,i;var aJ;var dS;var aK;if(jws.ho){jws.fk=jws.fq[jws.gu];aK=fE.match(/MSIE.*/i);if(aK){aJ=aK[0].substr(5);p=aJ.indexOf(";");jws.eO=p>0?aJ.substr(0,p):aJ;jws.eH=parseFloat(jws.eO);}}else if(jws.fP){jws.fk=jws.fq[jws.fY];aK=fE.match(/Firefox\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");if(p>0){jws.eO=aJ.substring(0,p);}else{jws.eO=aJ;}dS=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){dS++;}if(dS>=2){break;}i++;}aJ=aJ.substring(0,i);jws.eH=parseFloat(aJ);}}else if(jws.hB){jws.fk=jws.fq[jws.gi];aK=fE.match(/Netscape\/.*/i);if(aK){aJ=aK[0].substr(9);p=aJ.indexOf(" ");if(p>0){jws.eO=aJ.substring(0,p);}else{jws.eO=aJ;}dS=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){dS++;}if(dS>=2){break;}i++;}aJ=aJ.substring(0,i);jws.eH=parseFloat(aJ);}}else if(jws.fZ){jws.fk=jws.fq[jws.gG];aK=fE.match(/Opera\/.*/i);if(aK){aJ=aK[0].substr(6);p=aJ.indexOf(" ");jws.eO=p>0?aJ.substr(0,p):aJ;jws.eH=parseFloat(aJ);aK=fE.match(/Version\/.*/i);aJ=aK[0].substr(8);if(aK){p=aJ.indexOf(" ");jws.eO=(p>0?aJ.substr(0,p):aJ)+"/"+jws.eO;jws.eH=parseFloat(aJ);}}}else if(jws.hn){jws.fk=jws.fq[jws.jv];aK=fE.match(/Chrome\/.*/i);if(aK){aJ=aK[0].substr(7);p=aJ.indexOf(" ");jws.eO=p>0?aJ.substr(0,p):aJ;jws.eH=parseFloat(aJ);}}else if(jws.hw){jws.fk=jws.fq[jws.gl];aK=fE.match(/Version\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");jws.eO=p>0?aJ.substr(0,p):aJ;dS=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){dS++;}if(dS>=2){break;}i++;}aJ=aJ.substring(0,i);jws.eH=parseFloat(aJ);aK=fE.match(/Safari\/.*/i);if(aK){aJ="."+aK[0].substr(7);p=aJ.indexOf(" ");jws.eO+=p>0?aJ.substr(0,p):aJ;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},jx:function(gD){if(gD&&typeof ck=="string"){}return gD;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},jY:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},kM:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},jJ:function(ey,hj,hU){var iR=hU||"";var he=null;var eh=null;for(eh in hj){he="set"+eh.substr(0,1).toUpperCase()+eh.substr(1);if(typeof(ey[he])=="function"){ey[he](hj[eh]);}else{ey[iR+eh]=hj[eh];}}return ey;},hs:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["hs"])){return ey.hs();}if(ey instanceof Date){return new Date(ey.getTime());}var ix=function(hf){var gx=hf.length;var hy=[];if(gx>0){for(var cI=0;cI<gx;cI++){hy[cI]=jws.tools.hs(hf[cI]);}}return hy;};var dH=new ey.constructor();for(var gv in ey){var dM=ey[gv];if(dM instanceof Array)dH[gv]=ix(dM);else{dH[gv]=jws.tools.hs(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
