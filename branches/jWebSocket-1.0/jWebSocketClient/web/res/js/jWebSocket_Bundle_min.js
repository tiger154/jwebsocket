...
//	---------------------------------------------------------------------------
if(window.iw){window.WebSocket=window.iw;}var jws={VERSION:"1.0b6 (nightly build 20416)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,hw:1000,jJ:1001,jz:{fk:false,jc: -1,jl: -1,he: -1,hl: -1},ll:{fk:true,jc:2000,jl:30000,he:1000,hl:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kw:"org.jwebsocket.text",kN:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,jk:0,ge:1,gl:2,gG:3,hE:4,gA:5,iD:6,eH:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],kF:"guest",kO:"guest",lo:"root",iI:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),im:function(){return this.fL;},gr:function(){return this.fB;},ir:function(){return this.eD;},isFirefox:function(){return this.gL;},iW:function(){return this.hn;},hM:function(){return this.fR;},ht:function(){return this.hJ;},ih:function(){return(this.ht()&&this.gr()<7);},iA:function(){return(this.ht()&&this.gr()<8);},hU:function(){return(this.ht()&&this.gr()>=8);},je:function(){return this.gw;},jp:function(){return this.hz;},jh:function(){return this.gC;},console:{fI:false,fq:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,gE:function(){return(window.console&&jws.console.fI&&jws.console.fq<=jws.console.DEBUG);},ji:function(){return(window.console&&jws.console.fI&&jws.console.fq<=jws.console.INFO);},log:function(fg){if(window.console&&jws.console.fI){console.log(fg);}},fM:function(fg){if(window.console&&jws.console.fI&&jws.console.fq<=jws.console.DEBUG){if(console.fM){console.fM(fg);}else{console.log("[fM]: "+fg);}}},info:function(fg){if(window.console&&jws.console.fI&&jws.console.fq<=jws.console.INFO){if(console.info){console.info(fg);}else{console.log("[info]: "+fg);}}},hk:function(fg){if(window.console&&jws.console.fI&&jws.console.fq<=jws.console.WARN){if(console.hk){console.hk(fg);}else{console.log("[hk]: "+fg);}}},error:function(fg){if(window.console&&jws.console.fI&&jws.console.fq<=jws.console.ERROR){if(console.error){console.error(fg);}else{console.log("[error]: "+fg);}}},hC:function(fg){if(window.console&&jws.console.fI&&jws.console.fq<=jws.console.FATAL){if(console.hC){console.hC(fg);}else{console.log("[hC]: "+fg);}}},kh:function(){return jws.console.fq;},kf:function(fo){jws.console.fq=fo;},isActive:function(){return jws.console.fI;},setActive:function(eq){jws.console.fI=eq;}}};(function(){jws.fL="unknown";jws.eg=jws.jk;jws.fB=undefined;jws.hJ=false;jws.gL=false;jws.hz=false;jws.hn=false;jws.gw=false;jws.fR=false;var fA=navigator.userAgent;jws.fR=fA.indexOf("Chrome")>=0;if(jws.fR){jws.eg=jws.iD;}else{jws.gw=fA.indexOf("Safari")>=0;if(jws.gw){jws.eg=jws.gA;}else{jws.hz=fA.indexOf("Netscape")>=0;if(jws.hz){jws.eg=jws.gl;}else{jws.gL=navigator.appName=="Netscape";if(jws.gL){jws.eg=jws.ge;}else{jws.hn=navigator.appName=="Opera";if(jws.hn){jws.eg=jws.gG;}else{jws.hJ=navigator.appName=="Microsoft Internet Explorer";if(jws.hJ){jws.eg=jws.hE;}else{jws.gC=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gC){jws.eg=jws.hE;}}}}}}}var p,i;var ac;var fu;var aK;if(jws.hJ){jws.fL=jws.eH[jws.hE];aK=fA.match(/MSIE.*/i);if(aK){ac=aK[0].substr(5);p=ac.indexOf(";");jws.eD=p>0?ac.substr(0,p):ac;jws.fB=parseFloat(jws.eD);}}else if(jws.gL){jws.fL=jws.eH[jws.ge];aK=fA.match(/Firefox\/.*/i);if(aK){ac=aK[0].substr(8);p=ac.indexOf(" ");if(p>0){jws.eD=ac.substring(0,p);}else{jws.eD=ac;}fu=0;i=0;while(i<ac.length){if(ac.charAt(i)=='.'){fu++;}if(fu>=2){break;}i++;}ac=ac.substring(0,i);jws.fB=parseFloat(ac);}}else if(jws.hz){jws.fL=jws.eH[jws.gl];aK=fA.match(/Netscape\/.*/i);if(aK){ac=aK[0].substr(9);p=ac.indexOf(" ");if(p>0){jws.eD=ac.substring(0,p);}else{jws.eD=ac;}fu=0;i=0;while(i<ac.length){if(ac.charAt(i)=='.'){fu++;}if(fu>=2){break;}i++;}ac=ac.substring(0,i);jws.fB=parseFloat(ac);}}else if(jws.hn){jws.fL=jws.eH[jws.gG];aK=fA.match(/Opera\/.*/i);if(aK){ac=aK[0].substr(6);p=ac.indexOf(" ");jws.eD=p>0?ac.substr(0,p):ac;jws.fB=parseFloat(ac);aK=fA.match(/Version\/.*/i);ac=aK[0].substr(8);if(aK){p=ac.indexOf(" ");jws.eD=(p>0?ac.substr(0,p):ac)+"/"+jws.eD;jws.fB=parseFloat(ac);}}}else if(jws.fR){jws.fL=jws.eH[jws.iD];aK=fA.match(/Chrome\/.*/i);if(aK){ac=aK[0].substr(7);p=ac.indexOf(" ");jws.eD=p>0?ac.substr(0,p):ac;jws.fB=parseFloat(ac);}}else if(jws.gw){jws.fL=jws.eH[jws.gA];aK=fA.match(/Version\/.*/i);if(aK){ac=aK[0].substr(8);p=ac.indexOf(" ");jws.eD=p>0?ac.substr(0,p):ac;fu=0;i=0;while(i<ac.length){if(ac.charAt(i)=='.'){fu++;}if(fu>=2){break;}i++;}ac=ac.substring(0,i);jws.fB=parseFloat(ac);aK=fA.match(/Safari\/.*/i);if(aK){ac="."+aK[0].substr(7);p=ac.indexOf(" ");jws.eD+=p>0?ac.substr(0,p):ac;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},ke:function(jE){if(jE&&typeof ck=="string"){}return jE;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},ku:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},jH:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},kd:function(ey,gD,ik){var jw=ik||"";var hq=null;var fD=null;for(fD in gD){hq="set"+fD.substr(0,1).toUpperCase()+fD.substr(1);if(typeof(ey[hq])=="function"){ey[hq](gD[fD]);}else{ey[jw+fD]=gD[fD];}}return ey;},fX:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["fX"])){return ey.fX();}if(ey instanceof Date){return new Date(ey.getTime());}var iV=function(ho){var gB=ho.length;var gY=[];if(gB>0){for(var cf=0;cf<gB;cf++){gY[cf]=jws.tools.fX(ho[cf]);}}return gY;};var dH=new ey.constructor();for(var gP in ey){var dM=ey[gP];if(dM instanceof Array)dH[gP]=iV(dM);else{dH[gP]=jws.tools.fX(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
