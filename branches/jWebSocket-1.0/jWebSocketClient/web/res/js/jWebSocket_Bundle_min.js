...
//	---------------------------------------------------------------------------
if(window.iW){window.WebSocket=window.iW;}var jws={VERSION:"1.0b6 (nightly build 20223)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,fO:1000,jJ:1001,hU:{fi:false,il: -1,hV: -1,gY: -1,hF: -1},iz:{fi:true,il:2000,hV:30000,gY:1000,hF:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",jR:"org.jwebsocket.text",ll:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,ia:0,gK:1,gg:2,fR:3,hb:4,iC:5,gE:6,fA:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],lq:"guest",kJ:"guest",iE:"root",jc:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),iH:function(){return this.fu;},gU:function(){return this.fg;},hK:function(){return this.dT;},isFirefox:function(){return this.gO;},kM:function(){return this.gs;},kk:function(){return this.he;},gV:function(){return this.gi;},jS:function(){return(this.gV()&&this.gU()<7);},kZ:function(){return(this.gV()&&this.gU()<8);},ks:function(){return(this.gV()&&this.gU()>=8);},lp:function(){return this.gM;},jZ:function(){return this.ho;},jI:function(){return this.gS;},console:{fj:false,fI:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,fT:function(){return(window.console&&jws.console.fj&&jws.console.fI<=jws.console.DEBUG);},ki:function(){return(window.console&&jws.console.fj&&jws.console.fI<=jws.console.INFO);},log:function(eh){if(window.console&&jws.console.fj){console.log(eh);}},fL:function(eh){if(window.console&&jws.console.fj&&jws.console.fI<=jws.console.DEBUG){if(console.fL){console.fL(eh);}else{console.log("[fL]: "+eh);}}},info:function(eh){if(window.console&&jws.console.fj&&jws.console.fI<=jws.console.INFO){if(console.info){console.info(eh);}else{console.log("[info]: "+eh);}}},hq:function(eh){if(window.console&&jws.console.fj&&jws.console.fI<=jws.console.WARN){if(console.hq){console.hq(eh);}else{console.log("[hq]: "+eh);}}},error:function(eh){if(window.console&&jws.console.fj&&jws.console.fI<=jws.console.ERROR){if(console.error){console.error(eh);}else{console.log("[error]: "+eh);}}},gy:function(eh){if(window.console&&jws.console.fj&&jws.console.fI<=jws.console.FATAL){if(console.gy){console.gy(eh);}else{console.log("[gy]: "+eh);}}},iX:function(){return jws.console.fI;},jh:function(fo){jws.console.fI=fo;},isActive:function(){return jws.console.fj;},setActive:function(eq){jws.console.fj=eq;}}};(function(){jws.fu="unknown";jws.er=jws.ia;jws.fg=undefined;jws.gi=false;jws.gO=false;jws.ho=false;jws.gs=false;jws.gM=false;jws.he=false;var fs=navigator.userAgent;jws.he=fs.indexOf("Chrome")>=0;if(jws.he){jws.er=jws.gE;}else{jws.gM=fs.indexOf("Safari")>=0;if(jws.gM){jws.er=jws.iC;}else{jws.ho=fs.indexOf("Netscape")>=0;if(jws.ho){jws.er=jws.gg;}else{jws.gO=navigator.appName=="Netscape";if(jws.gO){jws.er=jws.gK;}else{jws.gs=navigator.appName=="Opera";if(jws.gs){jws.er=jws.fR;}else{jws.gi=navigator.appName=="Microsoft Internet Explorer";if(jws.gi){jws.er=jws.hb;}else{jws.gS=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gS){jws.er=jws.hb;}}}}}}}var p,i;var aJ;var eK;var dO;if(jws.gi){jws.fu=jws.fA[jws.hb];dO=fs.match(/MSIE.*/i);if(dO){aJ=dO[0].substr(5);p=aJ.indexOf(";");jws.dT=p>0?aJ.substr(0,p):aJ;jws.fg=parseFloat(jws.dT);}}else if(jws.gO){jws.fu=jws.fA[jws.gK];dO=fs.match(/Firefox\/.*/i);if(dO){aJ=dO[0].substr(8);p=aJ.indexOf(" ");if(p>0){jws.dT=aJ.substring(0,p);}else{jws.dT=aJ;}eK=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eK++;}if(eK>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fg=parseFloat(aJ);}}else if(jws.ho){jws.fu=jws.fA[jws.gg];dO=fs.match(/Netscape\/.*/i);if(dO){aJ=dO[0].substr(9);p=aJ.indexOf(" ");if(p>0){jws.dT=aJ.substring(0,p);}else{jws.dT=aJ;}eK=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eK++;}if(eK>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fg=parseFloat(aJ);}}else if(jws.gs){jws.fu=jws.fA[jws.fR];dO=fs.match(/Opera\/.*/i);if(dO){aJ=dO[0].substr(6);p=aJ.indexOf(" ");jws.dT=p>0?aJ.substr(0,p):aJ;jws.fg=parseFloat(aJ);dO=fs.match(/Version\/.*/i);aJ=dO[0].substr(8);if(dO){p=aJ.indexOf(" ");jws.dT=(p>0?aJ.substr(0,p):aJ)+"/"+jws.dT;jws.fg=parseFloat(aJ);}}}else if(jws.he){jws.fu=jws.fA[jws.gE];dO=fs.match(/Chrome\/.*/i);if(dO){aJ=dO[0].substr(7);p=aJ.indexOf(" ");jws.dT=p>0?aJ.substr(0,p):aJ;jws.fg=parseFloat(aJ);}}else if(jws.gM){jws.fu=jws.fA[jws.iC];dO=fs.match(/Version\/.*/i);if(dO){aJ=dO[0].substr(8);p=aJ.indexOf(" ");jws.dT=p>0?aJ.substr(0,p):aJ;eK=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eK++;}if(eK>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fg=parseFloat(aJ);dO=fs.match(/Safari\/.*/i);if(dO){aJ="."+dO[0].substr(7);p=aJ.indexOf(" ");jws.dT+=p>0?aJ.substr(0,p):aJ;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},jw:function(gB){if(gB&&typeof ck=="string"){}return gB;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},hW:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},kX:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},gn:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gn"])){return ey.gn();}if(ey instanceof Date){return new Date(ey.getTime());}var hQ=function(io){var hI=io.length;var gX=[];if(hI>0){for(var cf=0;cf<hI;cf++){gX[cf]=jws.tools.gn(io[cf]);}}return gX;};var dH=new ey.constructor();for(var gj in ey){var dM=ey[gj];if(dM instanceof Array)dH[gj]=hQ(dM);else{dH[gj]=jws.tools.gn(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
