...
//	---------------------------------------------------------------------------
if(window.ic){window.WebSocket=window.ic;}var jws={VERSION:"1.0b6 (nightly build 20223)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,gj:1000,kn:1001,ii:{eh:false,jB: -1,jg: -1,hn: -1,hj: -1},jp:{eh:true,jB:2000,jg:30000,hn:1000,hj:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kW:"org.jwebsocket.text",ld:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,ih:0,hg:1,gQ:2,hH:3,fV:4,jl:5,gh:6,eb:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],kQ:"guest",kq:"guest",ja:"root",il:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),iF:function(){return this.er;},gM:function(){return this.fF;},js:function(){return this.eo;},isFirefox:function(){return this.gZ;},kZ:function(){return this.fW;},kF:function(){return this.gW;},hl:function(){return this.gJ;},kd:function(){return(this.hl()&&this.gM()<7);},kT:function(){return(this.hl()&&this.gM()<8);},jJ:function(){return(this.hl()&&this.gM()>=8);},jQ:function(){return this.ht;},ky:function(){return this.gK;},lo:function(){return this.gL;},console:{eg:false,dS:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,hp:function(){return(window.console&&jws.console.eg&&jws.console.dS<=jws.console.DEBUG);},kA:function(){return(window.console&&jws.console.eg&&jws.console.dS<=jws.console.INFO);},log:function(eU){if(window.console&&jws.console.eg){console.log(eU);}},fE:function(eU){if(window.console&&jws.console.eg&&jws.console.dS<=jws.console.DEBUG){if(console.fE){console.fE(eU);}else{console.log("[fE]: "+eU);}}},info:function(eU){if(window.console&&jws.console.eg&&jws.console.dS<=jws.console.INFO){if(console.info){console.info(eU);}else{console.log("[info]: "+eU);}}},hz:function(eU){if(window.console&&jws.console.eg&&jws.console.dS<=jws.console.WARN){if(console.hz){console.hz(eU);}else{console.log("[hz]: "+eU);}}},error:function(eU){if(window.console&&jws.console.eg&&jws.console.dS<=jws.console.ERROR){if(console.error){console.error(eU);}else{console.log("[error]: "+eU);}}},gm:function(eU){if(window.console&&jws.console.eg&&jws.console.dS<=jws.console.FATAL){if(console.gm){console.gm(eU);}else{console.log("[gm]: "+eU);}}},iI:function(){return jws.console.dS;},jv:function(fo){jws.console.dS=fo;},isActive:function(){return jws.console.eg;},setActive:function(eq){jws.console.eg=eq;}}};(function(){jws.er="unknown";jws.fi=jws.ih;jws.fF=undefined;jws.gJ=false;jws.gZ=false;jws.gK=false;jws.fW=false;jws.ht=false;jws.gW=false;var fG=navigator.userAgent;jws.gW=fG.indexOf("Chrome")>=0;if(jws.gW){jws.fi=jws.gh;}else{jws.ht=fG.indexOf("Safari")>=0;if(jws.ht){jws.fi=jws.jl;}else{jws.gK=fG.indexOf("Netscape")>=0;if(jws.gK){jws.fi=jws.gQ;}else{jws.gZ=navigator.appName=="Netscape";if(jws.gZ){jws.fi=jws.hg;}else{jws.fW=navigator.appName=="Opera";if(jws.fW){jws.fi=jws.hH;}else{jws.gJ=navigator.appName=="Microsoft Internet Explorer";if(jws.gJ){jws.fi=jws.fV;}else{jws.gL=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gL){jws.fi=jws.fV;}}}}}}}var p,i;var aK;var dT;var dO;if(jws.gJ){jws.er=jws.eb[jws.fV];dO=fG.match(/MSIE.*/i);if(dO){aK=dO[0].substr(5);p=aK.indexOf(";");jws.eo=p>0?aK.substr(0,p):aK;jws.fF=parseFloat(jws.eo);}}else if(jws.gZ){jws.er=jws.eb[jws.hg];dO=fG.match(/Firefox\/.*/i);if(dO){aK=dO[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.eo=aK.substring(0,p);}else{jws.eo=aK;}dT=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){dT++;}if(dT>=2){break;}i++;}aK=aK.substring(0,i);jws.fF=parseFloat(aK);}}else if(jws.gK){jws.er=jws.eb[jws.gQ];dO=fG.match(/Netscape\/.*/i);if(dO){aK=dO[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.eo=aK.substring(0,p);}else{jws.eo=aK;}dT=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){dT++;}if(dT>=2){break;}i++;}aK=aK.substring(0,i);jws.fF=parseFloat(aK);}}else if(jws.fW){jws.er=jws.eb[jws.hH];dO=fG.match(/Opera\/.*/i);if(dO){aK=dO[0].substr(6);p=aK.indexOf(" ");jws.eo=p>0?aK.substr(0,p):aK;jws.fF=parseFloat(aK);dO=fG.match(/Version\/.*/i);aK=dO[0].substr(8);if(dO){p=aK.indexOf(" ");jws.eo=(p>0?aK.substr(0,p):aK)+"/"+jws.eo;jws.fF=parseFloat(aK);}}}else if(jws.gW){jws.er=jws.eb[jws.gh];dO=fG.match(/Chrome\/.*/i);if(dO){aK=dO[0].substr(7);p=aK.indexOf(" ");jws.eo=p>0?aK.substr(0,p):aK;jws.fF=parseFloat(aK);}}else if(jws.ht){jws.er=jws.eb[jws.jl];dO=fG.match(/Version\/.*/i);if(dO){aK=dO[0].substr(8);p=aK.indexOf(" ");jws.eo=p>0?aK.substr(0,p):aK;dT=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){dT++;}if(dT>=2){break;}i++;}aK=aK.substring(0,i);jws.fF=parseFloat(aK);dO=fG.match(/Safari\/.*/i);if(dO){aK="."+dO[0].substr(7);p=aK.indexOf(" ");jws.eo+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},jn:function(gX){if(gX&&typeof ck=="string"){}return gX;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},iW:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},jY:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},gb:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gb"])){return ey.gb();}if(ey instanceof Date){return new Date(ey.getTime());}var iu=function(jz){var fO=jz.length;var gq=[];if(fO>0){for(var cf=0;cf<fO;cf++){gq[cf]=jws.tools.gb(jz[cf]);}}return gq;};var dH=new ey.constructor();for(var gx in ey){var dM=ey[gx];if(dM instanceof Array)dH[gx]=iu(dM);else{dH[gx]=jws.tools.gb(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
