...
//	---------------------------------------------------------------------------
if(window.jl){window.WebSocket=window.jl;}var jws={VERSION:"1.0b6 (nightly build 20407)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,hI:1000,kh:1001,iR:{ec:false,hl: -1,iM: -1,ge: -1,gh: -1},kN:{ec:true,hl:2000,iM:30000,ge:1000,gh:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kB:"org.jwebsocket.text",lp:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,iK:0,gN:1,hw:2,fX:3,gI:4,gH:5,iH:6,eH:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],jY:"guest",kA:"guest",jO:"root",la:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),iB:function(){return this.eo;},hm:function(){return this.eE;},jd:function(){return this.fI;},isFirefox:function(){return this.gP;},js:function(){return this.hj;},kv:function(){return this.fV;},gv:function(){return this.fZ;},jC:function(){return(this.gv()&&this.hm()<7);},jA:function(){return(this.gv()&&this.hm()<8);},jV:function(){return(this.gv()&&this.hm()>=8);},ii:function(){return this.fQ;},iZ:function(){return this.gA;},iT:function(){return this.gQ;},console:{fF:false,eU:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,gz:function(){return(window.console&&jws.console.fF&&jws.console.eU<=jws.console.DEBUG);},iU:function(){return(window.console&&jws.console.fF&&jws.console.eU<=jws.console.INFO);},log:function(fG){if(window.console&&jws.console.fF){console.log(fG);}},fk:function(fG){if(window.console&&jws.console.fF&&jws.console.eU<=jws.console.DEBUG){if(console.fk){console.fk(fG);}else{console.log("[fk]: "+fG);}}},info:function(fG){if(window.console&&jws.console.fF&&jws.console.eU<=jws.console.INFO){if(console.info){console.info(fG);}else{console.log("[info]: "+fG);}}},gC:function(fG){if(window.console&&jws.console.fF&&jws.console.eU<=jws.console.WARN){if(console.gC){console.gC(fG);}else{console.log("[gC]: "+fG);}}},error:function(fG){if(window.console&&jws.console.fF&&jws.console.eU<=jws.console.ERROR){if(console.error){console.error(fG);}else{console.log("[error]: "+fG);}}},hy:function(fG){if(window.console&&jws.console.fF&&jws.console.eU<=jws.console.FATAL){if(console.hy){console.hy(fG);}else{console.log("[hy]: "+fG);}}},ky:function(){return jws.console.eU;},ka:function(fo){jws.console.eU=fo;},isActive:function(){return jws.console.fF;},setActive:function(eq){jws.console.fF=eq;}}};(function(){jws.eo="unknown";jws.eQ=jws.iK;jws.eE=undefined;jws.fZ=false;jws.gP=false;jws.gA=false;jws.hj=false;jws.fQ=false;jws.fV=false;var fs=navigator.userAgent;jws.fV=fs.indexOf("Chrome")>=0;if(jws.fV){jws.eQ=jws.iH;}else{jws.fQ=fs.indexOf("Safari")>=0;if(jws.fQ){jws.eQ=jws.gH;}else{jws.gA=fs.indexOf("Netscape")>=0;if(jws.gA){jws.eQ=jws.hw;}else{jws.gP=navigator.appName=="Netscape";if(jws.gP){jws.eQ=jws.gN;}else{jws.hj=navigator.appName=="Opera";if(jws.hj){jws.eQ=jws.fX;}else{jws.fZ=navigator.appName=="Microsoft Internet Explorer";if(jws.fZ){jws.eQ=jws.gI;}else{jws.gQ=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gQ){jws.eQ=jws.gI;}}}}}}}var p,i;var aK;var fq;var aJ;if(jws.fZ){jws.eo=jws.eH[jws.gI];aJ=fs.match(/MSIE.*/i);if(aJ){aK=aJ[0].substr(5);p=aK.indexOf(";");jws.fI=p>0?aK.substr(0,p):aK;jws.eE=parseFloat(jws.fI);}}else if(jws.gP){jws.eo=jws.eH[jws.gN];aJ=fs.match(/Firefox\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.fI=aK.substring(0,p);}else{jws.fI=aK;}fq=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fq++;}if(fq>=2){break;}i++;}aK=aK.substring(0,i);jws.eE=parseFloat(aK);}}else if(jws.gA){jws.eo=jws.eH[jws.hw];aJ=fs.match(/Netscape\/.*/i);if(aJ){aK=aJ[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.fI=aK.substring(0,p);}else{jws.fI=aK;}fq=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fq++;}if(fq>=2){break;}i++;}aK=aK.substring(0,i);jws.eE=parseFloat(aK);}}else if(jws.hj){jws.eo=jws.eH[jws.fX];aJ=fs.match(/Opera\/.*/i);if(aJ){aK=aJ[0].substr(6);p=aK.indexOf(" ");jws.fI=p>0?aK.substr(0,p):aK;jws.eE=parseFloat(aK);aJ=fs.match(/Version\/.*/i);aK=aJ[0].substr(8);if(aJ){p=aK.indexOf(" ");jws.fI=(p>0?aK.substr(0,p):aK)+"/"+jws.fI;jws.eE=parseFloat(aK);}}}else if(jws.fV){jws.eo=jws.eH[jws.iH];aJ=fs.match(/Chrome\/.*/i);if(aJ){aK=aJ[0].substr(7);p=aK.indexOf(" ");jws.fI=p>0?aK.substr(0,p):aK;jws.eE=parseFloat(aK);}}else if(jws.fQ){jws.eo=jws.eH[jws.gH];aJ=fs.match(/Version\/.*/i);if(aJ){aK=aJ[0].substr(8);p=aK.indexOf(" ");jws.fI=p>0?aK.substr(0,p):aK;fq=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){fq++;}if(fq>=2){break;}i++;}aK=aK.substring(0,i);jws.eE=parseFloat(aK);aJ=fs.match(/Safari\/.*/i);if(aJ){aK="."+aJ[0].substr(7);p=aK.indexOf(" ");jws.fI+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},iJ:function(fP){if(fP&&typeof ck=="string"){}return fP;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},lf:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},kl:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},kH:function(ey,gF,jq){var hK=jq||"";var hE=null;var fL=null;for(fL in gF){hE="set"+fL.substr(0,1).toUpperCase()+fL.substr(1);if(typeof(ey[hE])=="function"){ey[hE](gF[fL]);}else{ey[hK+fL]=gF[fL];}}return ey;},gr:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gr"])){return ey.gr();}if(ey instanceof Date){return new Date(ey.getTime());}var ib=function(gi){var hp=gi.length;var gs=[];if(hp>0){for(var dO=0;dO<hp;dO++){gs[dO]=jws.tools.gr(gi[dO]);}}return gs;};var dH=new ey.constructor();for(var hg in ey){var dM=ey[hg];if(dM instanceof Array)dH[hg]=ib(dM);else{dH[hg]=jws.tools.gr(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
