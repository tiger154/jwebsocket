...
//	---------------------------------------------------------------------------
if(window.im){window.WebSocket=window.im;}var jws={VERSION:"1.0b6 (nightly build 20223)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,ho:1000,la:1001,iD:{ee:false,iS: -1,il: -1,hy: -1,gq: -1},jE:{ee:true,iS:2000,il:30000,hy:1000,gq:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",ks:"org.jwebsocket.text",kh:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,it:0,gH:1,hq:2,gU:3,gr:4,hW:5,gE:6,fs:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],lb:"guest",lx:"guest",iM:"root",ib:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),jd:function(){return this.fu;},fO:function(){return this.fM;},hQ:function(){return this.fA;},isFirefox:function(){return this.gm;},kA:function(){return this.gO;},kc:function(){return this.gk;},gN:function(){return this.gb;},kU:function(){return(this.gN()&&this.fO()<7);},kz:function(){return(this.gN()&&this.fO()<8);},kM:function(){return(this.gN()&&this.fO()>=8);},jM:function(){return this.fW;},ld:function(){return this.hg;},jZ:function(){return this.gd;},console:{en:false,fG:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,gn:function(){return(window.console&&jws.console.en&&jws.console.fG<=jws.console.DEBUG);},km:function(){return(window.console&&jws.console.en&&jws.console.fG<=jws.console.INFO);},log:function(fD){if(window.console&&jws.console.en){console.log(fD);}},eH:function(fD){if(window.console&&jws.console.en&&jws.console.fG<=jws.console.DEBUG){if(console.eH){console.eH(fD);}else{console.log("[eH]: "+fD);}}},info:function(fD){if(window.console&&jws.console.en&&jws.console.fG<=jws.console.INFO){if(console.info){console.info(fD);}else{console.log("[info]: "+fD);}}},fP:function(fD){if(window.console&&jws.console.en&&jws.console.fG<=jws.console.WARN){if(console.fP){console.fP(fD);}else{console.log("[fP]: "+fD);}}},error:function(fD){if(window.console&&jws.console.en&&jws.console.fG<=jws.console.ERROR){if(console.error){console.error(fD);}else{console.log("[error]: "+fD);}}},hd:function(fD){if(window.console&&jws.console.en&&jws.console.fG<=jws.console.FATAL){if(console.hd){console.hd(fD);}else{console.log("[hd]: "+fD);}}},hL:function(){return jws.console.fG;},jr:function(fo){jws.console.fG=fo;},isActive:function(){return jws.console.en;},setActive:function(eq){jws.console.en=eq;}}};(function(){jws.fu="unknown";jws.eb=jws.it;jws.fM=undefined;jws.gb=false;jws.gm=false;jws.hg=false;jws.gO=false;jws.fW=false;jws.gk=false;var eK=navigator.userAgent;jws.gk=eK.indexOf("Chrome")>=0;if(jws.gk){jws.eb=jws.gE;}else{jws.fW=eK.indexOf("Safari")>=0;if(jws.fW){jws.eb=jws.hW;}else{jws.hg=eK.indexOf("Netscape")>=0;if(jws.hg){jws.eb=jws.hq;}else{jws.gm=navigator.appName=="Netscape";if(jws.gm){jws.eb=jws.gH;}else{jws.gO=navigator.appName=="Opera";if(jws.gO){jws.eb=jws.gU;}else{jws.gb=navigator.appName=="Microsoft Internet Explorer";if(jws.gb){jws.eb=jws.gr;}else{jws.gd=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gd){jws.eb=jws.gr;}}}}}}}var p,i;var aK;var eJ;var cI;if(jws.gb){jws.fu=jws.fs[jws.gr];cI=eK.match(/MSIE.*/i);if(cI){aK=cI[0].substr(5);p=aK.indexOf(";");jws.fA=p>0?aK.substr(0,p):aK;jws.fM=parseFloat(jws.fA);}}else if(jws.gm){jws.fu=jws.fs[jws.gH];cI=eK.match(/Firefox\/.*/i);if(cI){aK=cI[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.fA=aK.substring(0,p);}else{jws.fA=aK;}eJ=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){eJ++;}if(eJ>=2){break;}i++;}aK=aK.substring(0,i);jws.fM=parseFloat(aK);}}else if(jws.hg){jws.fu=jws.fs[jws.hq];cI=eK.match(/Netscape\/.*/i);if(cI){aK=cI[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.fA=aK.substring(0,p);}else{jws.fA=aK;}eJ=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){eJ++;}if(eJ>=2){break;}i++;}aK=aK.substring(0,i);jws.fM=parseFloat(aK);}}else if(jws.gO){jws.fu=jws.fs[jws.gU];cI=eK.match(/Opera\/.*/i);if(cI){aK=cI[0].substr(6);p=aK.indexOf(" ");jws.fA=p>0?aK.substr(0,p):aK;jws.fM=parseFloat(aK);cI=eK.match(/Version\/.*/i);aK=cI[0].substr(8);if(cI){p=aK.indexOf(" ");jws.fA=(p>0?aK.substr(0,p):aK)+"/"+jws.fA;jws.fM=parseFloat(aK);}}}else if(jws.gk){jws.fu=jws.fs[jws.gE];cI=eK.match(/Chrome\/.*/i);if(cI){aK=cI[0].substr(7);p=aK.indexOf(" ");jws.fA=p>0?aK.substr(0,p):aK;jws.fM=parseFloat(aK);}}else if(jws.fW){jws.fu=jws.fs[jws.hW];cI=eK.match(/Version\/.*/i);if(cI){aK=cI[0].substr(8);p=aK.indexOf(" ");jws.fA=p>0?aK.substr(0,p):aK;eJ=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){eJ++;}if(eJ>=2){break;}i++;}aK=aK.substring(0,i);jws.fM=parseFloat(aK);cI=eK.match(/Safari\/.*/i);if(cI){aK="."+cI[0].substr(7);p=aK.indexOf(" ");jws.fA+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},iW:function(gT){if(gT&&typeof ck=="string"){}return gT;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},ir:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},jV:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},hf:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["hf"])){return ey.hf();}if(ey instanceof Date){return new Date(ey.getTime());}var ih=function(hR){var gR=hR.length;var gW=[];if(gR>0){for(var dO=0;dO<gR;dO++){gW[dO]=jws.tools.hf(hR[dO]);}}return gW;};var dH=new ey.constructor();for(var gI in ey){var dM=ey[gI];if(dM instanceof Array)dH[gI]=ih(dM);else{dH[gI]=jws.tools.hf(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
