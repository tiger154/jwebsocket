...
//	---------------------------------------------------------------------------
if(window.iE){window.WebSocket=window.iE;}var jws={VERSION:"1.0b6 (nightly build 20123)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,gZ:1000,kp:1001,hP:{fu:false,gw: -1,iT: -1,hm: -1,gg: -1},ly:{fu:true,gw:2000,iT:30000,hm:1000,gg:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",kX:"org.jwebsocket.text",km:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,ia:0,gL:1,fX:2,gB:3,hE:4,gm:5,fU:6,ef:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],kx:"guest",lb:"guest",kR:"root",kF:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),jb:function(){return this.dX;},gl:function(){return this.dV;},hO:function(){return this.fC;},isFirefox:function(){return this.fR;},hZ:function(){return this.gk;},kB:function(){return this.hk;},gv:function(){return this.hg;},iV:function(){return(this.gv()&&this.gl()<7);},io:function(){return(this.gv()&&this.gl()<8);},iw:function(){return(this.gv()&&this.gl()>=8);},hU:function(){return this.hn;},iK:function(){return this.hu;},hY:function(){return this.gu;},console:{isActive:false,level:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,gQ:function(){return(window.console&&jws.console.isActive&&jws.console.level<=jws.console.DEBUG);},jg:function(){return(window.console&&jws.console.isActive&&jws.console.level<=jws.console.INFO);},log:function(eW){if(window.console&&jws.console.isActive){console.log(eW);}},fI:function(eW){if(window.console&&jws.console.isActive&&jws.console.level<=jws.console.DEBUG){if(console.fI){console.fI(eW);}else{console.log("[fI]: "+eW);}}},info:function(eW){if(window.console&&jws.console.isActive&&jws.console.level<=jws.console.INFO){if(console.info){console.info(eW);}else{console.log("[info]: "+eW);}}},gA:function(eW){if(window.console&&jws.console.isActive&&jws.console.level<=jws.console.WARN){if(console.gA){console.gA(eW);}else{console.log("[gA]: "+eW);}}},error:function(eW){if(window.console&&jws.console.isActive&&jws.console.level<=jws.console.ERROR){if(console.error){console.error(eW);}else{console.log("[error]: "+eW);}}},gr:function(eW){if(window.console&&jws.console.isActive&&jws.console.level<=jws.console.FATAL){if(console.gr){console.gr(eW);}else{console.log("[gr]: "+eW);}}},iP:function(){return jws.console.level;},kg:function(fo){jws.console.level=fo;},isActive:function(){return jws.console.isActive;},setActive:function(eq){jws.console.isActive=eq;}}};(function(){jws.dX="unknown";jws.eK=jws.ia;jws.dV=undefined;jws.hg=false;jws.fR=false;jws.hu=false;jws.gk=false;jws.hn=false;jws.hk=false;var eu=navigator.userAgent;jws.hk=eu.indexOf("Chrome")>=0;if(jws.hk){jws.eK=jws.fU;}else{jws.hn=eu.indexOf("Safari")>=0;if(jws.hn){jws.eK=jws.gm;}else{jws.hu=eu.indexOf("Netscape")>=0;if(jws.hu){jws.eK=jws.fX;}else{jws.fR=navigator.appName=="Netscape";if(jws.fR){jws.eK=jws.gL;}else{jws.gk=navigator.appName=="Opera";if(jws.gk){jws.eK=jws.gB;}else{jws.hg=navigator.appName=="Microsoft Internet Explorer";if(jws.hg){jws.eK=jws.hE;}else{jws.gu=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gu){jws.eK=jws.hE;}}}}}}}var p,i;var aJ;var eH;var aK;if(jws.hg){jws.dX=jws.ef[jws.hE];aK=eu.match(/MSIE.*/i);if(aK){aJ=aK[0].substr(5);p=aJ.indexOf(";");jws.fC=p>0?aJ.substr(0,p):aJ;jws.dV=parseFloat(jws.fC);}}else if(jws.fR){jws.dX=jws.ef[jws.gL];aK=eu.match(/Firefox\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");if(p>0){jws.fC=aJ.substring(0,p);}else{jws.fC=aJ;}eH=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eH++;}if(eH>=2){break;}i++;}aJ=aJ.substring(0,i);jws.dV=parseFloat(aJ);}}else if(jws.hu){jws.dX=jws.ef[jws.fX];aK=eu.match(/Netscape\/.*/i);if(aK){aJ=aK[0].substr(9);p=aJ.indexOf(" ");if(p>0){jws.fC=aJ.substring(0,p);}else{jws.fC=aJ;}eH=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eH++;}if(eH>=2){break;}i++;}aJ=aJ.substring(0,i);jws.dV=parseFloat(aJ);}}else if(jws.gk){jws.dX=jws.ef[jws.gB];aK=eu.match(/Opera\/.*/i);if(aK){aJ=aK[0].substr(6);p=aJ.indexOf(" ");jws.fC=p>0?aJ.substr(0,p):aJ;jws.dV=parseFloat(aJ);aK=eu.match(/Version\/.*/i);aJ=aK[0].substr(8);if(aK){p=aJ.indexOf(" ");jws.fC=(p>0?aJ.substr(0,p):aJ)+"/"+jws.fC;jws.dV=parseFloat(aJ);}}}else if(jws.hk){jws.dX=jws.ef[jws.fU];aK=eu.match(/Chrome\/.*/i);if(aK){aJ=aK[0].substr(7);p=aJ.indexOf(" ");jws.fC=p>0?aJ.substr(0,p):aJ;jws.dV=parseFloat(aJ);}}else if(jws.hn){jws.dX=jws.ef[jws.gm];aK=eu.match(/Version\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");jws.fC=p>0?aJ.substr(0,p):aJ;eH=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){eH++;}if(eH>=2){break;}i++;}aJ=aJ.substring(0,i);jws.dV=parseFloat(aJ);aK=eu.match(/Safari\/.*/i);if(aK){aJ="."+aK[0].substr(7);p=aJ.indexOf(" ");jws.fC+=p>0?aJ.substr(0,p):aJ;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},iz:function(hA){if(hA&&typeof ck=="string"){}return hA;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},hX:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},jM:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},gF:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gF"])){return ey.gF();}if(ey instanceof Date){return new Date(ey.getTime());}var il=function(fS){var iM=fS.length;var hD=[];if(iM>0){for(var fi=0;fi<iM;fi++){hD[fi]=jws.tools.gF(fS[fi]);}}return hD;};var dH=new ey.constructor();for(var gT in ey){var dM=ey[gT];if(dM instanceof Array)dH[gT]=il(dM);else{dH[gT]=jws.tools.gF(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
