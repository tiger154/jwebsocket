...
//	---------------------------------------------------------------------------
if(window.iP){window.WebSocket=window.iP;}var jws={VERSION:"1.0b6 (nightly build 20416)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,gf:1000,jX:1001,hL:{fL:false,ht: -1,ie: -1,gT: -1,fV: -1},lp:{fL:true,ht:2000,ie:30000,gT:1000,fV:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",ky:"org.jwebsocket.text",kK:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,ik:0,hp:1,fZ:2,hl:3,gI:4,fP:5,jq:6,eg:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],jW:"guest",lm:"guest",kg:"root",kW:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),hK:function(){return this.eD;},hF:function(){return this.fu;},is:function(){return this.fs;},isFirefox:function(){return this.gC;},hZ:function(){return this.gG;},jL:function(){return this.gD;},ho:function(){return this.gK;},ip:function(){return(this.ho()&&this.hF()<7);},iz:function(){return(this.ho()&&this.hF()<8);},kG:function(){return(this.ho()&&this.hF()>=8);},ji:function(){return this.gs;},jh:function(){return this.fQ;},js:function(){return this.hw;},console:{fC:false,ft:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,gB:function(){return(window.console&&jws.console.fC&&jws.console.ft<=jws.console.DEBUG);},hN:function(){return(window.console&&jws.console.fC&&jws.console.ft<=jws.console.INFO);},log:function(fI){if(window.console&&jws.console.fC){console.log(fI);}},eS:function(fI){if(window.console&&jws.console.fC&&jws.console.ft<=jws.console.DEBUG){if(console.eS){console.eS(fI);}else{console.log("[eS]: "+fI);}}},info:function(fI){if(window.console&&jws.console.fC&&jws.console.ft<=jws.console.INFO){if(console.info){console.info(fI);}else{console.log("[info]: "+fI);}}},fT:function(fI){if(window.console&&jws.console.fC&&jws.console.ft<=jws.console.WARN){if(console.fT){console.fT(fI);}else{console.log("[fT]: "+fI);}}},error:function(fI){if(window.console&&jws.console.fC&&jws.console.ft<=jws.console.ERROR){if(console.error){console.error(fI);}else{console.log("[error]: "+fI);}}},hC:function(fI){if(window.console&&jws.console.fC&&jws.console.ft<=jws.console.FATAL){if(console.hC){console.hC(fI);}else{console.log("[hC]: "+fI);}}},kL:function(){return jws.console.ft;},jN:function(fo){jws.console.ft=fo;},isActive:function(){return jws.console.fC;},setActive:function(eq){jws.console.fC=eq;}}};(function(){jws.eD="unknown";jws.eo=jws.ik;jws.fu=undefined;jws.gK=false;jws.gC=false;jws.fQ=false;jws.gG=false;jws.gs=false;jws.gD=false;var eZ=navigator.userAgent;jws.gD=eZ.indexOf("Chrome")>=0;if(jws.gD){jws.eo=jws.jq;}else{jws.gs=eZ.indexOf("Safari")>=0;if(jws.gs){jws.eo=jws.fP;}else{jws.fQ=eZ.indexOf("Netscape")>=0;if(jws.fQ){jws.eo=jws.fZ;}else{jws.gC=navigator.appName=="Netscape";if(jws.gC){jws.eo=jws.hp;}else{jws.gG=navigator.appName=="Opera";if(jws.gG){jws.eo=jws.hl;}else{jws.gK=navigator.appName=="Microsoft Internet Explorer";if(jws.gK){jws.eo=jws.gI;}else{jws.hw=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.hw){jws.eo=jws.gI;}}}}}}}var p,i;var aJ;var fD;var aK;if(jws.gK){jws.eD=jws.eg[jws.gI];aK=eZ.match(/MSIE.*/i);if(aK){aJ=aK[0].substr(5);p=aJ.indexOf(";");jws.fs=p>0?aJ.substr(0,p):aJ;jws.fu=parseFloat(jws.fs);}}else if(jws.gC){jws.eD=jws.eg[jws.hp];aK=eZ.match(/Firefox\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");if(p>0){jws.fs=aJ.substring(0,p);}else{jws.fs=aJ;}fD=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){fD++;}if(fD>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fu=parseFloat(aJ);}}else if(jws.fQ){jws.eD=jws.eg[jws.fZ];aK=eZ.match(/Netscape\/.*/i);if(aK){aJ=aK[0].substr(9);p=aJ.indexOf(" ");if(p>0){jws.fs=aJ.substring(0,p);}else{jws.fs=aJ;}fD=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){fD++;}if(fD>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fu=parseFloat(aJ);}}else if(jws.gG){jws.eD=jws.eg[jws.hl];aK=eZ.match(/Opera\/.*/i);if(aK){aJ=aK[0].substr(6);p=aJ.indexOf(" ");jws.fs=p>0?aJ.substr(0,p):aJ;jws.fu=parseFloat(aJ);aK=eZ.match(/Version\/.*/i);aJ=aK[0].substr(8);if(aK){p=aJ.indexOf(" ");jws.fs=(p>0?aJ.substr(0,p):aJ)+"/"+jws.fs;jws.fu=parseFloat(aJ);}}}else if(jws.gD){jws.eD=jws.eg[jws.jq];aK=eZ.match(/Chrome\/.*/i);if(aK){aJ=aK[0].substr(7);p=aJ.indexOf(" ");jws.fs=p>0?aJ.substr(0,p):aJ;jws.fu=parseFloat(aJ);}}else if(jws.gs){jws.eD=jws.eg[jws.fP];aK=eZ.match(/Version\/.*/i);if(aK){aJ=aK[0].substr(8);p=aJ.indexOf(" ");jws.fs=p>0?aJ.substr(0,p):aJ;fD=0;i=0;while(i<aJ.length){if(aJ.charAt(i)=='.'){fD++;}if(fD>=2){break;}i++;}aJ=aJ.substring(0,i);jws.fu=parseFloat(aJ);aK=eZ.match(/Safari\/.*/i);if(aK){aJ="."+aK[0].substr(7);p=aJ.indexOf(" ");jws.fs+=p>0?aJ.substr(0,p):aJ;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},iL:function(hG){if(hG&&typeof ck=="string"){}return hG;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},jZ:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},lu:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},lh:function(ey,fU,iu){var iA=iu||"";var gW=null;var dV=null;for(dV in fU){gW="set"+dV.substr(0,1).toUpperCase()+dV.substr(1);if(typeof(ey[gW])=="function"){ey[gW](fU[dV]);}else{ey[iA+dV]=fU[dV];}}return ey;},gQ:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["gQ"])){return ey.gQ();}if(ey instanceof Date){return new Date(ey.getTime());}var ib=function(hJ){var hq=hJ.length;var hD=[];if(hq>0){for(var dO=0;dO<hq;dO++){hD[dO]=jws.tools.gQ(hJ[dO]);}}return hD;};var dH=new ey.constructor();for(var gq in ey){var dM=ey[gq];if(dM instanceof Array)dH[gq]=ib(dM);else{dH[gq]=jws.tools.gQ(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
