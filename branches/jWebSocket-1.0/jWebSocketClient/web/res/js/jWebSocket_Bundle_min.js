...
//	---------------------------------------------------------------------------
if(window.jf){window.WebSocket=window.jf;}var jws={VERSION:"1.0b6 (nightly build 20223)",NS_BASE:"org.jwebsocket",NS_SYSTEM:"org.jwebsocket.plugins.system",MSG_WS_NOT_SUPPORTED:"Unfortunately your browser does neither natively support WebSockets\n"+"nor you have the Adobe Flash-PlugIn 10+ installed.\n"+"Please download the last recent Adobe Flash Player at http://get.adobe.com/flashplayer.",CUR_TOKEN_ID:0,JWS_SERVER_SCHEMA:"ws",JWS_SERVER_SSL_SCHEMA:"wss",JWS_SERVER_HOST:(self.location.hostname?self.location.hostname:"127.0.0.1"),JWS_SERVER_PORT:8787,JWS_SERVER_SSL_PORT:9797,JWS_SERVER_CONTEXT:"/jWebSocket",JWS_SERVER_SERVLET:"/jWebSocket",JWS_SERVER_URL:"ws://"+(self.location.hostname?self.location.hostname:"127.0.0.1")+":8787/jWebSocket/jWebSocket",CONNECTING:0,OPEN:1,CLOSING:2,CLOSED:3,gi:1000,kT:1001,hQ:{eo:false,ju: -1,ig: -1,gI: -1,gg: -1},jA:{eo:true,ju:2000,ig:30000,gI:1000,gg:1024*1024*10},WS_SUBPROT_JSON:"org.jwebsocket.json",WS_SUBPROT_XML:"org.jwebsocket.xml",WS_SUBPROT_CSV:"org.jwebsocket.csv",WS_SUBPROT_CUSTOM:"org.jwebsocket.text",ks:"org.jwebsocket.text",jG:"org.jwebsocket.binary",SCOPE_PRIVATE:"private",SCOPE_PUBLIC:"public",DEF_RESP_TIMEOUT:30000,jp:0,gv:1,gj:2,ho:3,gK:4,jv:5,hf:6,eK:["Unknown","Firefox","Netscape","Opera","Internet Explorer","Safari","Chrome"],lA:"guest",kE:"guest",ia:"root",jj:"root",$:function(aT){return document.getElementById(aT);},getServerURL:function(fm,bM,bv,dL,dc){var cW=fm+"://"+bM+(bv?":"+bv:"");if(dL&&dL.length>0){cW+=dL;if(dc&&dc.length>0){cW+=dc;}}return cW;},getDefaultServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},getDefaultSSLServerURL:function(){return(this.getServerURL(jws.JWS_SERVER_SSL_SCHEMA,jws.JWS_SERVER_HOST,jws.JWS_SERVER_SSL_PORT,jws.JWS_SERVER_CONTEXT,jws.JWS_SERVER_SERVLET));},browserSupportsWebSockets:function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);},browserSupportsNativeWebSockets:(function(){return(window.WebSocket!==null&&window.WebSocket!==undefined);})(),browserSupportsJSON:function(){return(window.JSON!==null&&window.JSON!==undefined);},browserSupportsNativeJSON:(function(){return(window.JSON!==null&&window.JSON!==undefined);})(),browserSupportsWebWorkers:(function(){return(window.Worker!==null&&window.Worker!==undefined);})(),runAsThread:function(ax){if(!this.browserSupportsWebWorkers){return{code: -1,msg:"Browser does not (yet) support WebWorkers."};}if(!ax){ax={};}var dv=null;var dG=null;var dw=jws.SCRIPT_PATH+"jwsWorker.js";var bu=null;var bC=[];if(ax.OnMessage&&typeof ax.OnMessage=="function"){dv=ax.OnMessage;}if(ax.OnError&&typeof ax.OnError=="function"){dG=ax.OnError;}if(ax.file&&typeof ax.file=="String"){dw=ax.file;}if(ax.method&&typeof ax.method=="function"){bu=ax.method;}if(ax.args){bC=ax.args;}var dJ=this;if(!jws.worker){jws.worker=new Worker(dw);jws.worker.onmessage=function(cz){if(dv!=null){dv.call(dJ,{data:cz.data});}};jws.worker.onerror=function(cz){if(dG!=null){dG.call(dJ,{message:cz.message});}};}jws.worker.postMessage({method:bu.toString(),args:bC});return{code:0,msg:"ok",worker:jws.worker};},SCRIPT_PATH:(function(){var bf=document.getElementsByTagName("script");for(var db=0,dB=bf.length;db<dB;db++){var bi=bf[db];var ad=bi.src;if(!ad){ad=bi.getAttribute("src");}if(ad){var bg=ad.lastIndexOf("jWebSocket");if(bg>0){return ad.substr(0,bg);}}}return null;})(),isIE:(function(){var aS=navigator.userAgent;var bJ=aS.indexOf("MSIE");return(bJ>=0);})(),hM:function(){return this.fF;},gC:function(){return this.er;},iF:function(){return this.fj;},isFirefox:function(){return this.gp;},jR:function(){return this.gm;},jU:function(){return this.fO;},gy:function(){return this.gO;},kY:function(){return(this.gy()&&this.gC()<7);},ly:function(){return(this.gy()&&this.gC()<8);},lp:function(){return(this.gy()&&this.gC()>=8);},kW:function(){return this.gr;},kc:function(){return this.gs;},kN:function(){return this.gP;},console:{fC:false,eh:2,ALL:0,DEBUG:1,INFO:2,WARN:3,ERROR:4,FATAL:5,fY:function(){return(window.console&&jws.console.fC&&jws.console.eh<=jws.console.DEBUG);},kM:function(){return(window.console&&jws.console.fC&&jws.console.eh<=jws.console.INFO);},log:function(fk){if(window.console&&jws.console.fC){console.log(fk);}},eH:function(fk){if(window.console&&jws.console.fC&&jws.console.eh<=jws.console.DEBUG){if(console.eH){console.eH(fk);}else{console.log("[eH]: "+fk);}}},info:function(fk){if(window.console&&jws.console.fC&&jws.console.eh<=jws.console.INFO){if(console.info){console.info(fk);}else{console.log("[info]: "+fk);}}},gN:function(fk){if(window.console&&jws.console.fC&&jws.console.eh<=jws.console.WARN){if(console.gN){console.gN(fk);}else{console.log("[gN]: "+fk);}}},error:function(fk){if(window.console&&jws.console.fC&&jws.console.eh<=jws.console.ERROR){if(console.error){console.error(fk);}else{console.log("[error]: "+fk);}}},hp:function(fk){if(window.console&&jws.console.fC&&jws.console.eh<=jws.console.FATAL){if(console.hp){console.hp(fk);}else{console.log("[hp]: "+fk);}}},hT:function(){return jws.console.eh;},jb:function(fo){jws.console.eh=fo;},isActive:function(){return jws.console.fC;},setActive:function(eq){jws.console.fC=eq;}}};(function(){jws.fF="unknown";jws.dS=jws.jp;jws.er=undefined;jws.gO=false;jws.gp=false;jws.gs=false;jws.gm=false;jws.gr=false;jws.fO=false;var fd=navigator.userAgent;jws.fO=fd.indexOf("Chrome")>=0;if(jws.fO){jws.dS=jws.hf;}else{jws.gr=fd.indexOf("Safari")>=0;if(jws.gr){jws.dS=jws.jv;}else{jws.gs=fd.indexOf("Netscape")>=0;if(jws.gs){jws.dS=jws.gj;}else{jws.gp=navigator.appName=="Netscape";if(jws.gp){jws.dS=jws.gv;}else{jws.gm=navigator.appName=="Opera";if(jws.gm){jws.dS=jws.ho;}else{jws.gO=navigator.appName=="Microsoft Internet Explorer";if(jws.gO){jws.dS=jws.gK;}else{jws.gP=navigator.appName=="Microsoft Pocket Internet Explorer";if(jws.gP){jws.dS=jws.gK;}}}}}}}var p,i;var aK;var dV;var cf;if(jws.gO){jws.fF=jws.eK[jws.gK];cf=fd.match(/MSIE.*/i);if(cf){aK=cf[0].substr(5);p=aK.indexOf(";");jws.fj=p>0?aK.substr(0,p):aK;jws.er=parseFloat(jws.fj);}}else if(jws.gp){jws.fF=jws.eK[jws.gv];cf=fd.match(/Firefox\/.*/i);if(cf){aK=cf[0].substr(8);p=aK.indexOf(" ");if(p>0){jws.fj=aK.substring(0,p);}else{jws.fj=aK;}dV=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){dV++;}if(dV>=2){break;}i++;}aK=aK.substring(0,i);jws.er=parseFloat(aK);}}else if(jws.gs){jws.fF=jws.eK[jws.gj];cf=fd.match(/Netscape\/.*/i);if(cf){aK=cf[0].substr(9);p=aK.indexOf(" ");if(p>0){jws.fj=aK.substring(0,p);}else{jws.fj=aK;}dV=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){dV++;}if(dV>=2){break;}i++;}aK=aK.substring(0,i);jws.er=parseFloat(aK);}}else if(jws.gm){jws.fF=jws.eK[jws.ho];cf=fd.match(/Opera\/.*/i);if(cf){aK=cf[0].substr(6);p=aK.indexOf(" ");jws.fj=p>0?aK.substr(0,p):aK;jws.er=parseFloat(aK);cf=fd.match(/Version\/.*/i);aK=cf[0].substr(8);if(cf){p=aK.indexOf(" ");jws.fj=(p>0?aK.substr(0,p):aK)+"/"+jws.fj;jws.er=parseFloat(aK);}}}else if(jws.fO){jws.fF=jws.eK[jws.hf];cf=fd.match(/Chrome\/.*/i);if(cf){aK=cf[0].substr(7);p=aK.indexOf(" ");jws.fj=p>0?aK.substr(0,p):aK;jws.er=parseFloat(aK);}}else if(jws.gr){jws.fF=jws.eK[jws.jv];cf=fd.match(/Version\/.*/i);if(cf){aK=cf[0].substr(8);p=aK.indexOf(" ");jws.fj=p>0?aK.substr(0,p):aK;dV=0;i=0;while(i<aK.length){if(aK.charAt(i)=='.'){dV++;}if(dV>=2){break;}i++;}aK=aK.substring(0,i);jws.er=parseFloat(aK);cf=fd.match(/Safari\/.*/i);if(cf){aK="."+cf[0].substr(7);p=aK.indexOf(" ");jws.fj+=p>0?aK.substr(0,p):aK;}}}}());jws.events={addEventListener:(jws.isIE?function(as,cz,aA){as.attachEvent("on"+cz,aA);}:function(as,cz,aA){as.addEventListener(cz,aA,false);}),removeEventListener:(jws.isIE?function(as,cz,aA){as.detachEvent("on"+cz,aA);}:function(as,cz,aA){as.removeEventListener(cz,aA,false);}),getTarget:(jws.isIE?function(cz){return cz.srcElement;}:function(cz){return cz.target;}),preventDefault:(jws.isIE?function(cz){cz=window.event;if(cz){cz.returnValue=false;}}:function(cz){return cz.preventDefault();})};
...
;jws.tools={zerofill:function(ay,am){var bj=ay.toFixed(0);if(bj.length>am){bj=bj.substring(bj.length-am);}else{while(bj.length<am){bj="0"+bj;}}return bj;},calcMD5:function(aUTF8){return(hex_md5(aUTF8));},jd:function(gW){if(gW&&typeof ck=="string"){}return gW;},date2ISO:function(du){var fJ= -du.getTimezoneOffset();var dE=Math.abs(fJ);var bj=du.getUTCFullYear()+"-"+this.zerofill(du.getUTCMonth()+1,2)+"-"+this.zerofill(du.getUTCDate(),2)+"T"+this.zerofill(du.getUTCHours(),2)+":"+this.zerofill(du.getUTCMinutes(),2)+":"+this.zerofill(du.getUTCSeconds(),2)+"."+this.zerofill(du.getUTCMilliseconds(),3)+"Z";return bj;},ISO2Date:function(bp,bd){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(5,2)-1);dK.setUTCDate(bp.substr(8,2));dK.setUTCHours(bp.substr(11,2));dK.setUTCMinutes(bp.substr(14,2));dK.setUTCSeconds(bp.substr(17,2));dK.setUTCMilliseconds(bp.substr(20,3));return dK;},hU:function(du){var bj=du.getUTCFullYear()+this.zerofill(du.getUTCMonth()+1,2)+this.zerofill(du.getUTCDate(),2)+this.zerofill(du.getUTCHours(),2)+this.zerofill(du.getUTCMinutes(),2)+this.zerofill(du.getUTCSeconds(),2)+this.zerofill(du.getUTCMilliseconds(),2);return bj;},lv:function(bp){var dK=new Date();dK.setUTCFullYear(bp.substr(0,4));dK.setUTCMonth(bp.substr(4,2)-1);dK.setUTCDate(bp.substr(6,2));dK.setUTCHours(bp.substr(8,2));dK.setUTCMinutes(bp.substr(10,2));dK.setUTCSeconds(bp.substr(12,2));dK.setUTCMilliseconds(bp.substr(14,3));return dK;},generateSharedUTID:function(aR){var string=JSON.stringify(aR);var chars=string.split('');chars.sort();return hex_md5("{"+chars.toString()+"}");},getType:function(ey){var dM=ey;var bj=typeof dM;if("number"==bj){if((parseFloat(dM)==parseInt(dM))){bj="integer";}else{bj="double";}}else if(Object.prototype.toString.call(dM)==="[object Array]"){bj="array";}else if(dM===null){bj="null";}return bj;},fR:function(ey){if(null==ey||"object"!=typeof(cQ)){return ey;}if("function"==typeof(ey["fR"])){return ey.fR();}if(ey instanceof Date){return new Date(ey.getTime());}var iq=function(ix){var hh=ix.length;var gh=[];if(hh>0){for(var dO=0;dO<hh;dO++){gh[dO]=jws.tools.fR(ix[dO]);}}return gh;};var dH=new ey.constructor();for(var gf in ey){var dM=ey[gf];if(dM instanceof Array)dH[gf]=iq(dM);else{dH[gf]=jws.tools.fR(dM);}}return dH;}};if(!jws.browserSupportsNativeWebSockets){
	// --- swfobject.js ---
